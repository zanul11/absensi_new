...
(function (O, J) {
    "object" === typeof module && module.exports
        ? ((J["default"] = J), (module.exports = O.document ? J(O) : J))
    ...
    J(G, "parts/Globals.js", [], function () {
        ...
        return {
            ...
            hasBidiBug: t,
            hasTouch:
                E && "undefined" !== typeof E.documentElement.ontouchstart,
            isMS: h,
    ...
    J(G, "parts/Utilities.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.error = function (h, e, q) {
            ...
            q
                ? a.fireEvent(q, "displayError", { code: h, message: t }, u)
                : u();
        };
        a.Fx = function (a, e, q) {
            this.options = e;
        ...
        a.Fx.prototype = {
            ...
            run: function (h, e, q) {
                ...
                h !== e || this.elem["forceAnimate:" + this.prop]
            ...
            step: function (h) {
                ...
                u.attr && !u.element
                    ...
                    ? ((this.now = this.end),
                      ...
                      q && v && v.call(u),
                      (h = !1))
                    : ((this.pos = t.easing((e - this.startTime) / n)),
                      (this.now =
            ...
            initPath: function (h, e, q) {
                ...
                function v(a, c) {
                    for (var l = (k - a.length) / b; 0 < l && l--; )
                        (p = a.slice().splice(a.length / K - b, b * K)),
                            (p[0] = c[k - b - l * b]),
                            m && ((p[b - 6] = p[b - 2]), (p[b - 5] = p[b - 1])),
                            [].splice.apply(a, [a.length / K, 0].concat(p)),
                            x && l--;
                }
                e = e || "";
                var n,
                ...
                if (g && d) {
                    for (c = 0; c < g.length; c++)
                        if (g[c] === d[0]) {
                            ...
                            g[g.length - 1] === d[d.length - g.length + c]
                        ) {
                            n = g.length - c;
                            break;
                        }
        ...
        a.pick = function () {
            var a = arguments,
                ...
                t = a.length;
            for (e = 0; e < t; e++)
                if (((q = a[e]), "undefined" !== typeof q && null !== q))
                    return q;
        };
        a.css = function (h, e) {
            a.isMS &&
        ...
        a.pad = function (a, e, q) {
            return (
                Array((e || 2) + 1 - String(a).replace("-", "").length).join(
                    q || "0"
                ) + a
            );
        };
        ...
        a.datePropsToTimestamps = function (h) {
            a.objectEach(h, function (e, q) {
                a.isObject(e) && "function" === typeof e.getTime
                    ? (h[q] = e.getTime())
                    : (a.isObject(e) || a.isArray(e)) &&
                      a.datePropsToTimestamps(e);
            });
        };
                ...
                ? ((q = (q = h.match(t)) ? q[1] : -1),
                  null !== e &&
                      (e = a.numberFormat(
                          ...
                          q,
                          u.decimalPoint,
                          -1 < h.indexOf(",") ? u.thousandsSep : ""
                      )))
                : (e = (q || a.time).dateFormat(h, e));
            return e;
        };
        ...
        a.numberFormat = function (h, e, q, t) {
            ...
            -1 === e
                ...
                ? e &&
                  ...
                  ((n = e + +d[1]),
                  0 <= n
                      ? ((d[0] = (+d[0]).toExponential(n).split("e")[0]),
                        (e = n))
                      : ((d[0] = d[0].split(".")[0] || 0),
                        (h =
                            20 > e
                                ? (d[0] * Math.pow(10, d[1])).toFixed(e)
                                : 0),
                        (d[1] = 0)))
                : (e = 2);
            g = (
                Math.abs(d[1] ? d[0] : h) + Math.pow(10, -Math.max(e, v) - 1)
            ).toFixed(e);
            v = String(a.pInt(g));
        ...
        a.getStyle = function (h, e, q) {
            ...
            if ((h = B.getComputedStyle(h, void 0)))
                (h = h.getPropertyValue(e)),
        ...
        a.offset = function (a) {
            ...
            return {
                top:
                    a.top + (B.pageYOffset || e.scrollTop) - (e.clientTop || 0),
                left:
                    a.left +
        ...
        a.objectEach(
            ...
            function (h, e) {
                a[e] = function (a) {
                    return Array.prototype[h].apply(
                        a,
        ...
        a.fireEvent = function (h, e, q, t) {
            var u, v;
            q = q || {};
            H.createEvent && (h.dispatchEvent || h.fireEvent)
                ? ((u = H.createEvent("Events")),
                  u.initEvent(e, !0, !0),
                  a.extend(u, q),
                  h.dispatchEvent ? h.dispatchEvent(u) : h.fireEvent(e, u))
                : (q.target ||
                      a.extend(q, {
                          ...
                          !1 ===
                              (a[d]
                                  ? g[m]
                                      ...
                                      : a[d++]
                                  : g[m++]
                              ).fn.call(h, q) && q.preventDefault();
                  })(
                      h.protoEvents && h.protoEvents[e],
                      h.hcEvents && h.hcEvents[e]
                  ));
        ...
        a.animate = function (h, e, q) {
            ...
            a.isObject(q) ||
                ((g = arguments),
                (q = { duration: g[2], easing: g[3], complete: g[4] }));
            ...
            a.objectEach(e, function (d, g) {
                ...
                v = null;
                "d" === g
                    ? ((n.paths = n.initPath(h, h.d, e.d)),
                      (n.toD = e.d),
                      (t = 0),
                      (v = 1))
                    : h.attr
                    ? (t = h.attr(g))
                    : ((t = parseFloat(a.getStyle(h, g)) || 0),
                      "opacity" !== g && (u = "px"));
                v || (v = d);
    ...
    J(G, "parts/Color.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.Color.prototype = {
            ...
            init: function (h) {
                ...
                if (
                    (this.input = h =
                        this.names[h && h.toLowerCase ? h.toLowerCase() : ""] ||
                        h) &&
                    h.stops
                )
                    this.stops = h.stops.map(function (e) {
            ...
            get: function (a) {
                ...
                this.stops
                    ? ((t = H(e)),
                      ...
                      this.stops.forEach(function (e, h) {
            ...
            tweenTo: function (a, e) {
                ...
                t.length && h && h.length
                    ? ((a = 1 !== t[3] || 1 !== h[3]),
                      (e =
                          (a ? "rgba(" : "rgb(") +
                          Math.round(t[0] + (h[0] - t[0]) * (1 - e)) +
                          "," +
                          Math.round(t[1] + (h[1] - t[1]) * (1 - e)) +
                          "," +
                          Math.round(t[2] + (h[2] - t[2]) * (1 - e)) +
                          (a ? "," + (t[3] + (h[3] - t[3]) * (1 - e)) : "") +
                          ")"))
                    : (e = a.input || "none");
                return e;
    ...
    J(G, "parts/SvgRenderer.js", [G["parts/Globals.js"]], function (a) {
        ...
        b(E.prototype, {
            ...
            init: function (y, f) {
                this.element =
                    "span" === f ? v(f) : m.createElementNS(this.SVG_NS, f);
                this.renderer = y;
            ...
            animate: function (y, f, b) {
                ...
                0 !== c.duration
                    ? (b && (c.complete = b), h(this, y, c))
                    : (this.attr(y, void 0, b),
                      a.objectEach(
                          y,
                          function (a, y) {
                              c.step &&
                                  c.step.call(this, a, { prop: y, pos: 1 });
                          },
                          this
                      ));
                return this;
            ...
            complexColor: function (y, f, b) {
                ...
                a.fireEvent(
                    ...
                    function () {
                        y.radialGradient
                            ? (p = "radialGradient")
                            : y.linearGradient && (p = "linearGradient");
                        p &&
                            ((k = y[p]),
                            (S = r.gradients),
                            (m = y.stops),
                ...
                for (var y = a.length, f; y--; )
                    (f = a[y]),
                        "highcharts-text-outline" === f.getAttribute("class") &&
                            k(a, this.element.removeChild(f));
            },
            ...
            attr: function (y, f, b, c) {
                ...
                "string" === typeof y &&
                    ...
                    ((r = y), (y = {}), (y[r] = f));
                "string" === typeof y
                    ? (p = (this[y + "Getter"] || this._defaultGetter).call(
                          this,
                          y,
                          k
                      ))
                    ...
                    a &&
                        (null === a.width || "auto" === a.width
                            ...
                            : "text" === c.nodeName.toLowerCase() &&
                              a.width &&
                              (r = this.textWidth = I(a.width))),
                    (this.styles = a),
                    r && !N && this.renderer.forExport && delete a.width,
                    ...
                    : k &&
                      a.push(
                          "rotate(" +
                              k +
                              " " +
                              z(this.rotationOriginX, p.getAttribute("x"), 0) +
                              " " +
                              z(
            ...
            getBBox: function (a, f) {
                ...
                if (!y) {
                    ...
                    c.isSVG &&
                        ...
                        f &&
                            ((y.width =
                                Math.abs(c * Math.sin(r)) +
                                Math.abs(a * Math.cos(r))),
                            (y.height =
                                Math.abs(c * Math.cos(r)) +
                                Math.abs(a * Math.sin(r)))));
                    if (e && 0 < y.height) {
            ...
            setTextPath: function (f, b) {
                ...
                if (f && b && b.enabled) {
                    ...
                    n(r.dy) &&
                        (p.parentNode.setAttribute("dy", r.dy), delete r.dy);
                    n(r.dx) &&
                        (p.parentNode.setAttribute("dx", r.dx), delete r.dx);
            ...
            zIndexSetter: function (a, f) {
                ...
                n(a)
                    ? (k.setAttribute("data-z-index", a),
                      (a = +a),
                      this[f] === a && (r = !1))
                    : n(this[f]) && k.removeAttribute("data-z-index");
                this[f] = a;
                if (r) {
                    ...
                    for (d = f.length - 1; 0 <= d && !l; d--)
                        if (
                            ...
                            if (0 > a && p && !b && !d)
                                c.insertBefore(k, f[d]), (l = !0);
                            else if (I(r) <= a || (p && (!n(a) || 0 <= a)))
                                c.insertBefore(k, f[d + 1] || null), (l = !0);
        ...
        E.prototype[
            "stroke-widthSetter"
        ] = E.prototype.strokeSetter = function (a, f, b) {
            this[f] = a;
        ...
        b(H.prototype, {
            ...
            init: function (a, f, b, c, r, k, l) {
                ...
                -1 === a.innerHTML.indexOf("xmlns") &&
                    e(c, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = c;
                this.boxWrapper = y;
                this.alignedObjects = [];
                this.url =
                    (x || C) && m.getElementsByTagName("base").length
                        ? R.location.href
                              .split("#")[0]
                              .replace(/<[^>]*>/g, "")
                              .replace(/([\('\)])/g, "\\$1")
                ...
                this.createElement("desc")
                    .add()
                    .element.appendChild(
                        m.createTextNode("Created with Highcharts 7.1.2")
                    );
                ...
                x &&
                    ...
                    f(),
                    (this.unSubPixelFix = B(R, "resize", f)));
            },
            definition: function (a) {
                function f(a, c) {
                    ...
                    r(a).forEach(function (a) {
                        ...
                        r.add(c || b.defs);
                        a.textContent &&
                            r.element.appendChild(
                                m.createTextNode(a.textContent)
                            );
                        f(a.children || [], r);
                        y = r;
                    });
                        ...
                        if (void 0 === x[p])
                            if (f.getSubStringLength)
                                try {
                                    x[p] =
                                        r +
                                        f.getSubStringLength(0, c ? p + 1 : p);
                                } catch (Z) {
                                    ("");
                                }
                            else
            ...
            buildText: function (a) {
                    ...
                    F = function (a) {
                        ...
                        b.styledMode ||
                            (c = /(px|em)$/.test(a && a.style.fontSize)
                                ? a.style.fontSize
                                : Q || b.style.fontSize || 12);
                        return x
                            ? I(x)
                            : b.fontMetrics(c, a.getAttribute("style") ? a : f)
                                  .h;
                    },
                    R = function (a, f) {
                ...
                if (M !== a.textCache) {
                    ...
                    y || n || D || g || -1 !== r.indexOf(" ")
                        ...
                        : f.appendChild(m.createTextNode(R(r)));
                }
            },
            ...
            arc: function (a, f, b, c, r, k) {
                w(a)
                    ? ((c = a), (f = c.y), (b = c.r), (a = c.x))
                    : (c = { innerR: c, start: r, end: k });
            ...
            symbol: function (a, f, c, r, k, d) {
                ...
                L
                    ? ((l = this.path(x)),
                      ...
                      b(l, { symbolName: A, x: f, y: c, width: r, height: k }),
                      d && b(l, d))
                    : g &&
                      ((e = a.match(y)[1]),
                      (l = this.image(e)),
                      (l.imgwidth = z(M[e] && M[e].width, d && d.width)),
                      (l.imgheight = z(M[e] && M[e].height, d && d.height)),
                      (D = function () {
            ...
            symbols: {
                ...
                arc: function (a, f, b, c, r) {
                    ...
                    c = z(
                        r.open,
                        0.001 > Math.abs(r.end - r.start - 2 * Math.PI)
                    );
                    var y = Math.cos(d),
                        g = Math.sin(d),
                        A = Math.cos(p),
                        p = Math.sin(p),
                        d = 0.001 > r.end - d - Math.PI ? 0 : 1;
                    r = [
                        "M",
                        a + k * y,
                        f + l * g,
                ...
                c ||
                    (a.xSetter = function (a, f, b) {
                        ...
                        for (l = 0; l < c.length; l++)
                            (r = c[l]),
                                r.getAttribute(f) === d && r.setAttribute(f, a);
                        b.setAttribute(f, a);
                    });
                return a;
            },
            fontMetrics: function (a, f) {
                a =
                    (!this.styledMode && /px/.test(a)) || !R.getComputedStyle
                        ...
                        : f && E.prototype.getStyle.call(f, "font-size");
                a = /px/.test(a) ? I(a) : 12;
            ...
            label: function (c, r, d, k, p, g, A, L, x) {
                ...
                U = function () {
                    ...
                    t =
                        M +
                        Math.min(
                            y.fontMetrics(a && a.fontSize, D).b,
                            z ? z.height : Infinity
                        );
                    u &&
                        (w ||
                            ((m.box = w =
                                y.symbols[k] || q ? y.symbol(k) : y.rect()),
                            w.addClass(
                            ...
                            (f.x = a),
                            (f.y = (L ? -t : 0) + a)),
                        (f.width = Math.round(m.width)),
                        (f.height = Math.round(m.height)),
                        w.attr(b(f, v)),
                        (v = {}));
                };
                P = function () {
                    ...
                    n(C) &&
                        z &&
                        ("center" === R || "right" === R) &&
                        (a += { center: 0.5, right: 1 }[R] * (C - z.width));
                    if (a !== D.x || f !== D.y)
                        D.attr("x", a),
                            D.hasBoxWidthChanged && ((z = D.getBBox(!0)), U()),
                            void 0 !== f && D.attr("y", f);
                    D.x = a;
                    D.y = f;
                };
                ...
                e
                    ? (m.rSetter = function (a, f) {
                          T(f, a);
                      })
                    : (m.strokeSetter = m.fillSetter = m.rSetter = function (
                          a,
                          f
                      ) {
                          "r" !== f &&
    ...
    J(G, "parts/Html.js", [G["parts/Globals.js"]], function (a) {
        ...
        e(g.prototype, {
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === d.tagName) {
                        var C = this.rotation,
                            ...
                            z;
                        (z = D !== this.oldTextWidth) &&
                            !(z = D > this.oldTextWidth) &&
                            ((z = this.textPxLength) ||
                                (B(d, { width: "", whiteSpace: l || "nowrap" }),
                                (z = d.offsetWidth)),
                            (z = z > D));
                        z &&
                        ...
                        A !== this.cTT &&
                            ((l = a.fontMetrics(d.style.fontSize, d).b),
                            !h(C) ||
                                (C === (this.oldRotation || 0) &&
                                    e === this.oldAlign) ||
                                this.setSpanRotation(C, F, l),
                            this.getSpanCorrection(
                                (!h(C) && this.textPxLength) || d.offsetWidth,
                                l,
                                F,
                                C,
                                e
            ...
            setSpanRotation: function (a, d, p) {
                ...
                b[k + (q ? "Origin" : "-origin")] = b.transformOrigin =
                    100 * d + "% " + p + "px";
                B(this.element, b);
            },
        ...
        e(d.prototype, {
            ...
            html: function (b, d, p) {
                ...
                c.attr({ text: b, x: Math.round(d), y: Math.round(p) }).css({
                    position: "absolute",
                });
                C ||
                    c.css({
                    ...
                    ? ((this.get = function (a, g) {
                      ...
                      (this.set = function (a, g, d) {
                          ...
                          if (
                              ...
                              "Seconds" === a ||
                              ("Minutes" === a &&
                                  0 === g.getTimezoneOffset() % 60)
                          )
                              g["set" + a](d);
                          else
                              (m = v.getTimezoneOffset(g)),
                                  (m = g.getTime() - m),
                                  g.setTime(m),
                                  g["setUTC" + a](d),
                                  (a = v.getTimezoneOffset(g)),
                                  (m = g.getTime() + a),
                                  g.setTime(m);
                      }))
                    : e
            ...
            dateFormat: function (e, h, v) {
                ...
                a.objectEach(g, function (a, b) {
                    for (; -1 !== e.indexOf("%" + b); )
                        e = e.replace(
                            "%" + b,
                            "function" === typeof a ? a.call(n, h) : a
                        );
                });
            ...
            getTimeTicks: function (a, q, v, n) {
                ...
                if (E(q)) {
                    g.set(
                        ...
                        p >= e.second
                            ? 0
                            : c * Math.floor(g.get("Milliseconds", m) / c)
                    );
                    p >= e.second &&
                        g.set(
                            "Seconds",
                            ...
                            p >= e.minute
                                ? 0
                                : c * Math.floor(g.get("Seconds", m) / c)
                        );
                    p >= e.minute &&
                        g.set(
                            "Minutes",
                            ...
                            p >= e.hour
                                ? 0
                                : c * Math.floor(g.get("Minutes", m) / c)
                        );
                    p >= e.hour &&
                        g.set(
                            "Hours",
                    ...
                    g.variableTimezone &&
                        (x =
                            v - q > 4 * e.month ||
                            g.getTimezoneOffset(q) !== g.getTimezoneOffset(v));
                    q = m.getTime();
                    for (m = 1; q < v; )
                        d.push(q),
                            (q =
                ...
                d.info = H(a, { higherRanks: b, totalRange: p * c });
                return d;
            },
        };
    });
    ...
    J(G, "parts/Tick.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.Tick.prototype = {
            addLabel: function () {
                ...
                n.isDatetimeAxis &&
                    c &&
                    ((C = d.time.resolveDTLFormat(
                        g.dateTimeLabelFormats[
                            (!g.grid && c.higherRanks[k]) || c.unitName
                        ]
                    )),
                    (F = C.main));
                e.isFirst = x;
                            ...
                            if (
                                (w.attr({
                                    text: n.labelFormatter.call(
                                        a.extend(e.formatCtx, {
                                            dateTimeLabelFormat: D[l],
                                        })
                                    ),
                                }),
                                w.getBBox().width <
                                    n.getSlotWidth(e) - 2 * t(p.padding, 5))
                            )
                                return;
                        w.attr({ text: "" });
                    };
            ...
            handleOverflow: function (a) {
                var e = this.axis,
                    ...
                    l,
                    D = {};
                if (c || "justify" !== t(g.overflow, "justify"))
                    0 > c && d - x * h < k
                        ? (l = Math.round(d / Math.cos(c * u) - k))
                        : 0 < c &&
                          d + x * h > b &&
                          (l = Math.round((m - d) / Math.cos(c * u)));
                else if (
                    ((m = d + (1 - x) * h),
                    d - x * h < k
                        ? (F = a.x + F * (1 - x) - k)
                    ...
                    F < w &&
                        "center" === e.labelAlign &&
                        (a.x += C * (w - F - x * (w - Math.min(h, F)))),
                    h > F || (e.autoRotation && (p.styles || {}).width))
                )
                    l = F;
                l &&
                    (this.shortenLabel
                        ? this.shortenLabel()
                        : ((D.width = Math.floor(l)),
            ...
            getPosition: function (e, n, g, d) {
                ...
                e = {
                    x: e
                        ? a.correctFloat(
                              m.translate(n + g, null, null, d) + m.transB
                          )
                        : m.left +
                          m.offset +
                          (m.opposite
                              ? ((d && b.oldChartWidth) || b.chartWidth) -
                                m.right -
                                m.left
                              : 0),
                    y: e
                        ? k - m.bottom + m.offset - (m.opposite ? m.height : 0)
                        : a.correctFloat(
                              k - m.translate(n + g, null, null, d) - m.transB
                          ),
                };
                ...
                c &&
                    ...
                    n &&
                        ((this.mark = x = b
                            ...
                            .add(d.axisGroup)),
                        d.chart.styledMode ||
                            x.attr({ stroke: m, "stroke-width": h })),
                    x[n ? "attr" : "animate"]({
                        d: this.getMarkPath(
                            w,
                            a,
            ...
            renderLabel: function (a, n, g, d) {
                ...
                p &&
                    e(w) &&
                    ((p.xy = a = this.getLabelPosition(w, a, p, b, c, m, d, x)),
                    (this.isFirst && !this.isLast && !t(k.showFirstLabel, 1)) ||
                    (this.isLast && !this.isFirst && !t(k.showLastLabel, 1))
                        ? (h = !1)
                        : !b ||
                          c.step ||
                          c.rotation ||
    ...
    J(G, "parts/Axis.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.extend(I.prototype, {
            ...
            init: function (f, b) {
                ...
                r.side =
                    b.side ||
                    (r.horiz ? (r.opposite ? 0 : 2) : r.opposite ? 1 : 3);
                r.setOptions(b);
                var l = this.options,
                    p = l.type;
                r.labelFormatter =
                    l.labels.formatter || r.defaultLabelFormatter;
                r.userOptions = b;
                r.minPixelPadding = 0;
                ...
                r.crosshair = F(
                    l.crosshair,
                    D(f.options.tooltip.crosshairs)[c ? 0 : 1],
                    !1
                );
                b = r.options.events;
                -1 === f.axes.indexOf(r) &&
                    (c ? f.axes.splice(f.xAxis.length, 0, r) : f.axes.push(r),
                    f[r.coll].push(r));
                r.series = r.series || [];
                f.inverted &&
                    !r.isZAxis &&
                    ...
                    a.series.forEach(function (f) {
                        if (f.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis)
                                ...
                                u(l) &&
                                    u(k) &&
                                    ((a.dataMin = Math.min(F(a.dataMin, l), l)),
                                    (a.dataMax = Math.max(F(a.dataMax, k), k))),
                                u(d) && (a.threshold = d),
            ...
            translate: function (a, b, c, d, l, k) {
                ...
                b
                    ? ((a = (a * r + e - m) / g + d), l && (a = f.lin2val(a)))
                    : (l && (a = f.val2lin(a)),
                      (a = p(d)
                          ? r * (a - d) * g + e + r * m + (p(k) ? g * k : 0)
                          : void 0));
                return a;
            },
            ...
            getPlotLinePath: function (a) {
                var f = this,
                    ...
                    q = function (a, f, b) {
                        if (("pass" !== A && a < f) || a > b)
                            A ? (a = Math.min(Math.max(f, a), b)) : (C = !0);
                        return a;
                    };
                a = {
                    value: e,
            ...
            getMinorTickPositions: function () {
                ...
                if (g && g / d < a.len / 3)
                    if (a.isLog)
                        this.paddedTicks.forEach(function (f, b, c) {
                            b &&
                                l.push.apply(
                                    l,
                                    a.getLogTickPositions(d, c[b - 1], c[b], !0)
                                );
                        });
                    else if (
                        a.isDatetimeAxis &&
                    ...
                    (k = f.getClosest()),
                        A
                            ...
                            : f.series.forEach(function (a) {
                                  ...
                                  if (!f.single || m)
                                      (a =
                                          l.xrange && a instanceof l.xrange
                                              ? !D
                                              : D),
                                          (g = Math.max(
                                              g,
                        ...
                        (A = f.ordinalSlope && k ? f.ordinalSlope / k : 1),
                        (f.minPointOffset = g *= A),
                        (f.pointRangePadding = e *= A),
                        (f.pointRange = Math.min(p, b)),
                        D && (f.closestPointRange = k);
                a && (f.oldTransA = x);
                f.translationSlope = f.transA = x =
                    f.staticScale || f.len / (b + e || 1);
            ...
            setTickInterval: function (f) {
                ...
                B = F(c.userMax, k.max);
                m
                    ? ((c.linkedParent = l[c.coll][k.linkedTo]),
                      (n = c.linkedParent.getExtremes()),
                      (c.min = F(n.min, n.dataMin)),
                      (c.max = F(n.max, n.dataMax)),
                      k.type !== c.linkedParent.options.type &&
                          a.error(11, 1, l))
                    : (!I &&
                          u(C) &&
                          (c.dataMin >= C
                              ? ((n = C), (D = 0))
                              : c.dataMax <= C && ((t = C), (x = 0))),
                      (c.min = F(v, n, c.dataMin)),
                      (c.max = F(B, t, c.dataMax)));
                g &&
                    (c.positiveValuesOnly &&
                        !f &&
                        0 >= Math.min(c.min, F(c.dataMin, c.min)) &&
                        a.error(10, 1, l),
                    (c.min = q(c.log2lin(c.min), 15)),
                    (c.max = q(c.log2lin(c.max), 15)));
                c.range &&
                    u(c.max) &&
                    ((c.userMin = c.min = v = Math.max(
                        c.dataMin,
                        c.minFromRange()
                    )),
                    (c.userMax = B = c.max),
                ...
                c.adjustForMinRange();
                !(h || c.axisPointRange || c.usePercentage || m) &&
                    u(c.min) &&
                    u(c.max) &&
                    (l = c.max - c.min) &&
                    (!u(v) && D && (c.min -= l * D),
                ...
                p(k.floor) &&
                    (c.min = Math.min(
                        Math.max(c.min, k.floor),
                        Number.MAX_VALUE
                    ));
                p(k.ceiling) &&
                    (c.max = Math.max(
                        Math.min(c.max, k.ceiling),
                        F(c.userMax, -Number.MAX_VALUE)
                    ));
                I &&
                    u(c.dataMin) &&
                    ((C = C || 0),
                    !u(v) && c.min < C && c.dataMin >= C
                        ? (c.min = c.options.minRange
                              ? Math.min(C, c.max - c.minRange)
                              : C)
                        : !u(B) &&
                          c.max > C &&
                          c.dataMax <= C &&
                          (c.max = c.options.minRange
                              ? Math.max(C, c.min + c.minRange)
                              : C));
                c.tickInterval =
                    c.min === c.max || void 0 === c.min || void 0 === c.max
                        ...
                        : m &&
                          !w &&
                          z === c.linkedParent.options.tickPixelInterval
                        ? (w = c.linkedParent.tickInterval)
                        : F(
                              w,
                              this.tickAmount
                                  ? (c.max - c.min) /
            ...
            setAxisSize: function () {
                var f = this.chart,
                    ...
                    l = (this.width = Math.round(
                        a.relativeLength(
                            F(c.width, f.plotWidth - b[3] + b[1]),
                            f.plotWidth
                        )
                    )),
                    k = (this.height = Math.round(
                        a.relativeLength(
                            F(c.height, f.plotHeight - b[0] + b[2]),
                            f.plotHeight
                        )
                    )),
                    p = (this.top = Math.round(
                        a.relativeLength(
                            F(c.top, f.plotTop + b[0]),
                            f.plotHeight,
                            f.plotTop
                        )
                    )),
            ...
            unsquish: function () {
                ...
                c
                    ? (m =
                          ...
                          (u(p)
                              ? [p]
                              : l < F(a.autoRotationLimit, 80) &&
                                a.autoRotation)) &&
                      m.forEach(function (a) {
                          var f;
                          if (a === p || (a && -90 <= a && 90 >= a))
                              (e = D(Math.abs(g.h / Math.sin(v * a)))),
                                  (f = e + Math.abs(a / 360)),
                                  f < A && ((A = f), (k = a), (d = e));
                      })
                    : a.step || (d = D(g.h));
            ...
            renderUnsquish: function () {
                ...
                d.forEach(function (a) {
                    (a = l[a]) &&
                        a.label &&
                        a.label.textPxLength > z &&
                        (z = a.label.textPxLength);
                });
                    ...
                    f &&
                        ...
                        a.shortenLabel
                            ...
                            : n &&
                              ...
                              "nowrap" !== p.whiteSpace &&
                              (n < f.textPxLength ||
                                  "SPAN" === f.element.tagName)
                            ? ((b.width = n),
                              D ||
                                  (b.textOverflow =
                                      f.specificTextOverflow || w),
                              f.css(b))
                            : f.styles &&
                              f.styles.width &&
                              !b.width &&
            ...
            addTitle: function (a) {
                ...
                this.axisTitle ||
                    ...
                    k || this.axisTitle.css(x(d.style)),
            ...
            getOffset: function () {
                ...
                m || a.isLinked
                    ? (k.forEach(function (c, b) {
                      ...
                      a.staggerLines && (I *= a.staggerLines),
                      (a.labelOffset = I * (a.opposite ? -1 : 1)))
                    : w(p, function (a, c) {
                          a.destroy();
                          delete p[c];
                      });
                C &&
                    ...
                    x &&
                        !1 !== C.reserveSpace &&
                        ((a.titleOffset = D = a.axisTitle.getBBox()[
                            g ? "height" : "width"
                        ]),
                        (n = C.offset),
                        (z = u(n) ? 0 : F(C.margin, g ? 5 : 10))));
                a.renderLine();
                ...
                I &&
                    (z =
                        z -
                        b +
                        K * (g ? F(h.y, a.tickRotCorr.y + 8 * K) : h.x));
                a.axisTitleMargin = F(n, z);
                a.getMaxLabelDimensions &&
                    (a.maxLabelDimensions = a.getMaxLabelDimensions(p, k));
                g = this.tickSize("tick");
                q[e] = Math.max(
                    q[e],
                    a.axisTitleMargin + D + K * a.offset,
                    z,
                    k && k.length && g ? g[0] + K * a.offset : 0
                );
            ...
            render: function () {
                ...
                if (c.hasData() || e)
                    c.minorTickInterval &&
                        ...
                        g.length &&
                            ...
                            I &&
                                (0 === c.min || c.single) &&
                                (x[-1] || (x[-1] = new z(c, -1, null, !0)),
                                x[-1].render(-1))),
                        h &&
                            g.forEach(function (f, l) {
                                v =
                                    void 0 !== g[l + 1]
                                        ? g[l + 1] + I
                                        : c.max - I;
                                0 === l % 2 &&
                                    f < c.max &&
                                    v <= c.max + (b.polar ? -I : I) &&
                                    (n[f] || (n[f] = new a.PlotLineOrBand(c)),
                                    (t = f + I),
                                    (n[f].options = {
                ...
                [x, D, n].forEach(function (a) {
                    ...
                    w(a, function (a, c) {
                        a.isActive ||
                            (a.render(c, !1, 0), (a.isActive = !1), f.push(c));
                    });
                    A(
                        function () {
                            for (c = f.length; c--; )
                ...
                m &&
                    F &&
                    ((l = c.getTitlePosition()),
                    p(l.y)
                        ? (m[m.isNew ? "attr" : "animate"](l), (m.isNew = !1))
            ...
            destroy: function (a) {
                ...
                for (l in c.plotLinesAndBandsGroups)
                    c.plotLinesAndBandsGroups[l] = c.plotLinesAndBandsGroups[
                        l
                    ].destroy();
                w(c, function (a, b) {
                ...
                if (this.crosshair && !1 !== (u(c) || !l)) {
                    ...
                    u(k) &&
                        (b =
                            this.getPlotLinePath({
                                value:
                                    c &&
                                    (this.isXAxis ? c.x : F(c.stackY, c.y)),
                                translatedValue: k,
                            }) || null);
                    if (!u(b)) {
                        this.hideCrosshair();
                    ...
                    p ||
                        ...
                        this.chart.styledMode ||
                            ...
                            f.dashStyle && p.attr({ dashstyle: f.dashStyle })));
                    p.show().attr({ d: b });
    ...
    J(G, "parts/DateTimeAxis.js", [G["parts/Globals.js"]], function (a) {
        ...
        E.prototype.normalizeTimeTickInterval = function (a, q) {
            ...
            for (
                ...
                (u = h[q[0]]),
                (v = q[1]),
                e[n + 1] && a <= (u * v[v.length - 1] + h[e[n + 1][0]]) / 2);
                n++
            );
    ...
    J(G, "parts/LogarithmicAxis.js", [G["parts/Globals.js"]], function (a) {
        ...
        E.prototype.getLogTickPositions = function (a, q, t, u) {
            ...
            if (0.5 <= a)
                (a = Math.round(a)), (g = this.getLinearTickPositions(a, q, t));
            else if (0.08 <= a)
                for (
                    var n = Math.floor(q),
                        d,
                    ...
                    for (m = e.length, d = 0; d < m && !p; d++)
                        (b = this.log2lin(this.lin2log(n) * e[d])),
                            b > q &&
                                (!u || k <= t) &&
                                void 0 !== k &&
                                g.push(k),
                ...
                (q = this.lin2log(q)),
                    ...
                    (a = h(
                        ...
                        ((e.tickPixelInterval / (u ? 5 : 1)) * (t - q)) /
                            ((u ? n / this.tickPositions.length : n) || 1)
                    )),
                    (a = B(a, null, H(a))),
                    (g = this.getLinearTickPositions(a, q, t).map(
                        this.log2lin
                    )),
            ...
            a.PlotLineOrBand.prototype = {
                render: function () {
                    ...
                    n.chart.styledMode ||
                        (q
                            ? ((C.stroke = l),
                              (C["stroke-width"] = d.width),
                              d.dashStyle && (C.dashstyle = d.dashStyle))
                            : x &&
                              (l && (C.fill = l),
                              d.borderWidth &&
                                  ((C.stroke = d.borderColor),
                                  (C["stroke-width"] = d.borderWidth))));
                    z.zIndex = D;
                    f += "-" + D;
                    (l = n.plotLinesAndBandsGroups[f]) ||
                        (n.plotLinesAndBandsGroups[f] = l = I.g("plot-" + f)
                            .attr(z)
                            .add());
                    ...
                    (F || !w.d) && C && C.length
                        ...
                        : w &&
                          (C
                              ? (w.show(!0), w.animate({ d: C }))
                              : w.d &&
                                (w.hide(), b && (e.label = b = b.destroy())));
                    m &&
                    h(m.text) &&
                    C &&
                    C.length &&
        ...
        a.Tooltip.prototype = {
            ...
            getLabel: function () {
                ...
                this.label ||
                    (this.outside &&
                        ...
                        (this.renderer = g = new a.Renderer(b, 0, 0))),
                    this.split
                    ...
                    this.outside &&
                        ((k = { x: this.label.xSetter, y: this.label.ySetter }),
            ...
            move: function (e, g, d, m) {
                var b = this,
                    ...
                    p =
                        ...
                        !b.isHidden &&
                        (1 < Math.abs(e - k.x) || 1 < Math.abs(g - k.y)),
            ...
            getAnchor: function (a, e) {
                ...
                this.followPointer && e
                    ? (void 0 === e.chartX && (e = g.normalize(e)),
                      (a = [e.chartX - d.plotLeft, e.chartY - k]))
                    : a[0].tooltipPos
                    ? (a = a[0].tooltipPos)
            ...
            getPosition: function (a, e, d) {
                var g = this.chart,
                    ...
                    x = this.outside,
                    h = x
                        ? E.documentElement.clientWidth - 2 * b
                        : g.chartWidth,
                    w = x
                        ? Math.max(
                              E.body.scrollHeight,
                    ...
                    C = [
                        ...
                        w,
                        e,
                        (x ? n.top - b : 0) + d.plotY + g.plotTop,
                        x ? 0 : g.plotTop,
                        x ? w : g.plotTop + g.plotHeight,
                    ],
                    l = [
                        "x",
                        h,
                        a,
                        (x ? n.left - b : 0) + d.plotX + g.plotLeft,
                        x ? 0 : g.plotLeft,
                        x ? h : g.plotLeft + g.plotWidth,
                    ],
                    D =
                        !this.followPointer &&
                        q(d.ttBelow, !g.inverted === !!d.negative),
                    A = function (a, c, f, l, d, e) {
                        ...
                        if (D && A) k[a] = l;
                            ...
                            k[a] = Math.min(e - f, 0 > m - p ? m : m - p);
                        else if (A)
                            k[a] = Math.max(d, l + p + f > c ? l : l + p);
                        else return !1;
                    },
                    z = function (a, c, f, l) {
                        var d;
            ...
            refresh: function (e, g) {
                ...
                m.enabled &&
                    ...
                    (p = this.getAnchor(k, g)),
                    (g = p[0]),
                    (b = p[1]),
                    !c || (k.series && k.series.noSharedTooltip)
                        ? (c = k.getLabelConfig())
                        : ((n = d.pointer.getActiveSeries(k)),
                    ...
                    !1 === x
                        ...
                        : ((d = this.getLabel()),
                          ...
                          this.split
                              ? this.renderSplit(x, t(e))
                              : ((m.style.width && !w) ||
                                    d.css({
                                        width: this.chart.spacingBox.width,
                                    }),
                                d.attr({ text: x && x.join ? x.join("") : x }),
                                d
                                    .removeClass(/highcharts-color-[\d]+/g)
                                    .addClass(
                                        "highcharts-color-" +
                                            q(k.colorIndex, c.colorIndex)
                                    ),
                                w ||
                                    d.attr({
                                        stroke:
            ...
            renderSplit: function (e, g) {
                ...
                e.slice(0, g.length + 1).forEach(function (a, l) {
                    if (!1 !== a && "" !== a) {
                        ...
                        var e = l.series || d,
                            ...
                            C =
                                "highcharts-color-" +
                                q(l.colorIndex, z.colorIndex, "none");
                        A ||
                            ((A = { padding: c.padding, r: c.borderRadius }),
                            b.styledMode ||
                            ...
                            (e.tt = A = k
                                .label(
                                    ...
                                    null,
                                    null,
                                    (l.isHeader ? c.headerShape : c.shape) ||
                                        "callout",
                                    null,
                                    null,
                                    c.useHTML
                        ...
                        l.isHeader
                            ? ((x = a.height),
                              b.xAxis[0].opposite && ((h = !0), (n -= x)),
                              (z = Math.max(
                                  0,
                                  Math.min(
                                      l.plotX + b.plotLeft - z / 2,
                                      b.chartWidth +
                                          (b.scrollablePixelsX
                                              ? b.scrollablePixelsX -
                                                b.marginRight
                            ...
                            : (z =
                                  l.plotX + b.plotLeft - q(c.distance, 16) - z);
                        0 > z && (p = !1);
                        a =
                            (l.series && l.series.yAxis && l.series.yAxis.pos) +
                            (l.plotY || 0);
                        a -= n;
                ...
                m.forEach(function (a) {
                    ...
                    a.tt.attr({
                        ...
                        x:
                            p || l.isHeader || c.positioner
                                ? a.x
                                : l.plotX + b.plotLeft + d.distance,
                        y: a.pos + n,
                        anchorX: l.isHeader
                            ? l.plotX + b.plotLeft
                            : l.plotX + k.xAxis.pos,
            ...
            updatePosition: function (a) {
                ...
                var k;
                this.outside &&
                    ((k = (this.options.borderWidth || 0) + 2 * this.distance),
                    this.renderer.setSize(d.width + k, d.height + k, !1),
            ...
            getDateFormat: function (a, e, d, m) {
                ...
                for (c in v) {
                    ...
                    if (
                        g[c] &&
                        k.substr(g[c]) !== "01-01 00:00:00.000".substr(g[c])
                    )
                        break;
                    "week" !== c && (h = c);
                }
            ...
            getXDateFormat: function (a, e, d) {
                ...
                return (
                    (g
                        ? this.getDateFormat(g, a.x, d.options.startOfWeek, e)
                        : e.day) || e.year
                );
            },
            tooltipFooterHeaderFormatter: function (e, g) {
                ...
                a.fireEvent(this, "headerFormatter", g, function (a) {
                    ...
                    c &&
                        k &&
                        (
                            (e.point && e.point.tooltipDateKeys) || ["key"]
                        ).forEach(function (a) {
                            x = x.replace(
                                "{point." + a + "}",
                                "{point." + a + ":" + k + "}"
            ...
            styledModeFormat: function (a) {
                return a
                    .replace(
                        'style\x3d"font-size: 10px"',
                        'class\x3d"highcharts-header"'
                    )
                    .replace(
    ...
    J(G, "parts/Pointer.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.Pointer.prototype = {
                    ...
                    (k && !c.noSharedTooltip
                        ? ((x = b.filter(function (a) {
                          ...
                          x.forEach(function (a) {
                              ...
                              g(c) &&
                                  (a.chart.isBoosting && (c = a.getPoint(c)),
                                  l.push(c));
                          }))
                        : l.push(p));
            ...
            drag: function (a) {
                ...
                (f && f.touch) ||
                    ...
                    (this.hasDragged = Math.sqrt(
                        Math.pow(r - d, 2) + Math.pow(q - k, 2)
                    )),
                    10 < this.hasDragged &&
                        ((n = c.isInsidePlot(r - l, q - g)),
            ...
            onContainerMouseMove: function (b) {
                ...
                (q(a.hoverChartIndex) &&
                    B[a.hoverChartIndex] &&
                    B[a.hoverChartIndex].mouseIsDown) ||
                ...
                c.cancelClick ||
                    (b && this.inClass(a.target, "highcharts-tracker")
                        ...
                        : (t(a, this.getCoordinates(a)),
                          c.isInsidePlot(a.chartX - d, a.chartY - k) &&
                              v(c, "click", a)));
            },
    ...
    J(G, "parts/TouchPointer.js", [G["parts/Globals.js"]], function (a) {
        ...
        H(a.Pointer.prototype, {
            pinchTranslate: function (a, h, t, u, v, n) {
                this.zoomHor &&
                    this.pinchTranslateDirection(!0, a, h, t, u, v, n);
                this.zoomVert &&
                    this.pinchTranslateDirection(!1, a, h, t, u, v, n);
            },
            ...
            pinch: function (a) {
                ...
                "touchstart" === a.type
                    ? ([].forEach.call(v, function (a, b) {
                      ...
                      (g.x = [u[0].chartX, u[1] && u[1].chartX]),
                      (g.y = [u[0].chartY, u[1] && u[1].chartY]),
                      t.axes.forEach(function (a) {
                          if (a.zoomEnabled) {
                              var b = t.bounds[a.horiz ? "h" : "v"],
                                  ...
                                  d = a.toPixels(
                                      Math.min(
                                          h(a.options.min, a.dataMin),
                                          a.dataMin
                                      )
                                  ),
                                  k = a.toPixels(
                                      Math.max(
                                          h(a.options.max, a.dataMax),
                                          a.dataMax
                                      )
                                  ),
                                  e = Math.max(d, k);
                    ...
                    : u.length &&
                      (m ||
                          (e.selectionMarker = m = H(
                              { destroy: B, touch: !0 },
                              t.plotBox
                          )),
                      e.pinchTranslate(u, v, b, m, p, g),
                      (e.hasPinched = d),
                      e.scaleGroups(b, p),
            ...
            e(t.prototype, {
                ...
                onContainerPointerMove: function (a) {
                    b(a, "onContainerTouchMove", "touchmove", function (a) {
                        ...
                        g[a.pointerId].target ||
                            (g[a.pointerId].target = a.currentTarget);
                    });
                },
        ...
        a.Legend.prototype = {
                ...
                a &&
                    ...
                    this.allItems.forEach(function (b) {
                        var k = b.checkbox,
                            g;
                        k &&
                            ((g = d + c + k.y + (this.scrollOffset || 0) + 3),
                            H(k, {
                                left:
                                    a.translateX +
                                    b.checkboxOffset +
                    ...
                    ((a.legendGroup = d
                        ...
                        .addClass(
                            "highcharts-" +
                                ...
                                a.colorIndex +
                                (r ? " " + r : "") +
                                (A ? " highcharts-series-" + a.index : "")
                        )
                        .attr({ zIndex: 1 })
                        .add(this.scrollGroup)),
                    (a.legendItem = D = d.text(
                        "",
                        l ? e + g : -g,
                        this.baseline || 0,
                        f
                    )),
                    b.styledMode || D.css(u(a.visible ? m : h)),
                    D.attr({ align: l ? "left" : "right", zIndex: 2 }).add(
                        a.legendGroup
                    ),
                    this.baseline ||
                ...
                (!b.styledMode && m.width) ||
                    D.css({
                        width:
                            (c.itemWidth ||
                                this.widthOption ||
                                b.spacingBox.width) - n,
                    });
                this.setText(a);
                b = D.getBBox();
                a.itemWidth = a.checkboxOffset =
                    c.itemWidth || a.legendItemWidth || b.width + n;
            ...
            layoutItem: function (a) {
                ...
                c &&
                    ...
                    ((this.itemX = d),
                    this.lastLineHeight &&
                        (this.itemY += m + this.lastLineHeight + g),
                ...
                c
                    ? (this.itemX += b)
                    : ((this.itemY += m + e + g), (this.lastLineHeight = e));
                this.offsetWidth =
                    this.widthOption ||
                    Math.max(
                        (c ? this.itemX - d - (a.checkbox ? 0 : h) : b) + d,
                        this.offsetWidth
                    );
            },
            getAllItems: function () {
                ...
                this.chart.series.forEach(function (b) {
                    var d = b && b.options;
                    b &&
                        v(d.showInLegend, h(d.linkedTo) ? !1 : void 0, !0) &&
                        (a = a.concat(
                            b.legendItems ||
                    ...
                    [
                        ...
                        g.test(e) &&
                            ...
                            (b[t[m]] = Math.max(
                                b[t[m]],
                                b.legend[
                                    (m + 1) % 2 ? "legendHeight" : "legendWidth"
                                ] +
                                    [1, -1, -1, 1][m] * c[m % 2 ? "x" : "y"] +
                                    v(c.margin, 12) +
                                    d[m] +
                                    (0 === m && (0 === b.titleOffset ? 0 : k))
                            ));
                    });
            },
            proximatePositions: function () {
                ...
                this.allItems.forEach(function (c) {
                    ...
                    c.yAxis &&
                        ...
                        (g = c.legendGroup.getBBox().height),
                        (m = c.yAxis.top - b.plotTop),
                        c.visible
                            ? ((k = k ? k.plotY : c.yAxis.height),
                              (k += m - 0.3 * g))
                            : (k = m + c.yAxis.height),
                        d.push({ target: k, size: g, item: c }));
                }, this);
            ...
            render: function () {
                ...
                this.widthOption = a.relativeLength(
                    q.width,
                    b.spacingBox.width - C
                );
                ...
                m ||
                    ((this.group = m = d.g("legend").attr({ zIndex: 7 }).add()),
                    (this.contentGroup = d.g().attr({ zIndex: 1 }).add(m)),
            ...
            handleOverflow: function (a) {
                ...
                a > g && !1 !== D.enabled
                    ? ((this.clipHeight = n = Math.max(
                      ...
                      l ||
                          ((l = b.clipRect = c.clipRect(0, m, 9999, 0)),
                      ...
                      I ||
                          ((this.nav = I = c
                              ...
                              .attr({ zIndex: 1 })
                              .add(this.group)),
                          (this.up = c.symbol("triangle", 0, 0, z, z).add(I)),
                          ...
                          d.styledMode || this.pager.css(D.style),
                          this.pager.add(I),
                          (this.down = c
                              .symbol("triangle-down", 0, 0, z, z)
                              .add(I)),
        ...
        m(N.prototype, {
            ...
            init: function (b, f) {
                ...
                k(this, "init", { args: arguments }, function () {
                    ...
                    C(d.plotOptions, function (a, b) {
                        c(a) &&
                            (a.tooltip = (e[b] && F(e[b].tooltip)) || void 0);
                    });
            ...
            redraw: function (b) {
                ...
                for (b = f.length; b--; )
                    if (
                        ((D = f[b]),
                        D.options.stacking && ((A = !0), D.isDirty))
                    ) {
                        p = !0;
                        break;
                    }
            ...
            getSelectedPoints: function () {
                ...
                this.series.forEach(function (b) {
                    a = a.concat(
                        (b[b.hasGroupedData ? "points" : "data"] || []).filter(
                            function (a) {
                                return a.selected;
                            }
                        )
            ...
            layOutTitles: function (a) {
                ...
                ["title", "subtitle"].forEach(function (a) {
                    ...
                    var e;
                    c &&
                        (this.styledMode || (e = l.style.fontSize),
                        (e = f.fontMetrics(e, c).b),
                        c
                            .css({
                                width:
                                    (l.width || d.width + l.widthAdjust) + "px",
                            })
                            .align(m({ y: a + e }, l), !1, "spacingBox"),
                        l.floating ||
                            l.verticalAlign ||
                            (b = Math.ceil(b + c.getBBox(l.useHTML).height)));
                }, this);
            ...
            getContainer: function () {
                ...
                this.renderer = new (a[f.renderer] || a.Renderer)(
                    b,
                    d,
                    l,
                    null,
            ...
            reflow: function (b) {
                ...
                if (!g && !c.isPrinting && k && f && (l === Q || l === e)) {
                    if (k !== c.containerWidth || f !== c.containerHeight)
            ...
            setChartSize: function (a) {
                ...
                this.plotBox = c.plotBox = { x: m, y: A, width: p, height: r };
                ...
                this.clipBox = {
                    ...
                    y: c,
                    width: Math.floor(
                        this.plotSizeX - Math.max(f, g[1]) / 2 - b
                    ),
                    height: Math.max(
                        0,
                        Math.floor(this.plotSizeY - Math.max(f, g[2]) / 2 - c)
                    ),
                };
                a ||
            ...
            drawChartBox: function () {
                ...
                l ||
                    ((t = "attr"),
                    (this.plotBackground = l = b
                        .rect()
                        .addClass("highcharts-plot-background")
                        .add()));
                l[t](C);
                m ||
                    (l.attr({ fill: r || "none" }).shadow(a.plotShadow),
                    h &&
                        (A
                            ? A.animate(C)
                            : (this.plotBGImage = b
                                  ...
                                  .add())));
                I
                    ? I.animate({ width: q.width, height: q.height })
    ...
    J(G, "parts/ScrollablePlotArea.js", [G["parts/Globals.js"]], function (a) {
        ...
        E(H, "afterSetChartSize", function (B) {
            ...
            if (!this.renderer.forExport) {
                if (e) {
                    if (
                        (this.scrollablePixelsX = e = Math.max(
                            0,
                            e - this.chartWidth
                        ))
                    )
                        (this.plotWidth += e),
                            ...
                            (q = { 1: { name: "right", value: e } });
                } else
                    h &&
                        (this.scrollablePixelsY = e = Math.max(
                            0,
                            h - this.chartHeight
                        )) &&
                        ((this.plotHeight += e),
        ...
        H.prototype.applyFixed = function () {
            ...
            e
                ? ((this.fixedDiv = a.createElement(
                  ...
                  (this.fixedRenderer = B = new a.Renderer(
                      this.fixedDiv,
                      this.chartWidth,
                      this.chartHeight
                  )),
                  (this.scrollableMask = B.path()
                      .attr({
                          fill: a
                              .color(
                                  this.options.chart.backgroundColor || "#fff"
                              )
                              .setOpacity(a.pick(q.opacity, 0.85))
                              .get(),
                          zIndex: -1,
                      })
            ...
            e &&
                (q.scrollPositionX &&
                    (this.scrollingContainer.scrollLeft =
                        this.scrollablePixelsX * q.scrollPositionX),
                q.scrollPositionY &&
                    (this.scrollingContainer.scrollTop =
                        this.scrollablePixelsY * q.scrollPositionY));
            h = this.axisOffset;
    ...
    J(G, "parts/Point.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.Point.prototype = {
            ...
            destroyElements: function (a) {
                ...
                a.dataLabel &&
                    b.push("dataLabel", "dataLabelUpper", "connector");
                for (g = b.length; g--; )
            ...
            },
            {
                ...
                autoIncrement: function () {
                    ...
                    e &&
                        ...
                        "day" === e
                            ...
                            : "year" === e &&
                              g.set("FullYear", a, g.get("FullYear", a) + d),
                        (d = a.getTime() - b));
                    this.xIncrement = b + d;
                    return b;
                },
                setOptions: function (a) {
                    ...
                    (!l.negativeColor && !l.negativeFillColor) ||
                        ...
                        b ||
                            ((e.color = l.negativeColor),
                            (e.fillColor = l.negativeFillColor)),
                        d.push(e));
                    d.length &&
                ...
                getCyclic: function (a, b, d) {
                    var e,
                        ...
                        m = d
                            ? d.length
                            : c(l.options.chart[a + "Count"], l[a + "Count"]);
                    b ||
                        ((e = c(f[g], f["_" + g])),
                        u(e) ||
                            (l.series.length || (l[k] = 0),
                            (f["_" + g] = e = l[k] % m),
                            (l[k] += 1)),
                        d && (b = d[e]));
                    void 0 !== e && (this[g] = e);
                    ...
                    n &&
                        ...
                        (c[e - 1] < C || c[0] > q
                            ...
                            : this.yData &&
                              ...
                              (f = !0)));
                    for (m = c.length || 1; --m; )
                        (e = x ? p(c[m]) - p(c[m - 1]) : c[m] - c[m - 1]),
                            0 < e && (void 0 === g || e < g)
                                ? (g = e)
                                : 0 > e &&
                                  w &&
                                  (a.error(15, !1, this.chart), (w = !1));
                    this.cropped = f;
                    this.cropStart = l;
                        ...
                        (h = p + q),
                            x
                                ? ((w = new k().init(
                                  ...
                                  (w.dataGroup = this.groupMap[q]),
                                  w.dataGroup.options &&
                                      ((w.options = w.dataGroup.options),
                                      n(w, w.dataGroup.options),
                                      delete w.dataLabels))
                                : (w = c[h]) ||
                                  void 0 === b[h] ||
                                  (c[h] = w = new k().init(this, b[h], e[q])),
                            w && ((w.index = h), (C[q] = w));
                    this.options.keys = a;
                    if (c && (m !== (d = c.length) || x))
                        for (q = 0; q < d; q++)
                ...
                getExtremes: function (a) {
                    ...
                    for (C = 0; C < e; C++)
                        if (
                            ...
                            (n =
                                (m(q, !0) || d(q)) &&
                                (!b.positiveValuesOnly || q.length || 0 < q)),
                            (w =
                ...
                translate: function () {
                    ...
                    for (w = 0; w < r; w++) {
                        ...
                        b &&
                            ...
                            O &&
                            O[J] &&
                            ((B = this.getStackIndicator(B, J, this.index)),
                            (W = O[J]),
                            (X = W.points[B.key]));
                        d(X) &&
                            ((V = X[0]),
                            ...
                            V === t &&
                                B.key === O[J].base &&
                                (V = c(m(x) && x, h.min)),
                            h.positiveValuesOnly && 0 >= V && (V = null),
                        ...
                        G.yBottom = u(V)
                            ? Math.min(
                                  Math.max(-1e5, h.translate(V, 0, 1, 0, 1)),
                                  1e5
                              )
                            : null;
                        ...
                        G.isNull ||
                            (void 0 !== K && (H = Math.min(H, Math.abs(F - K))),
                            (K = F));
                    ...
                    var q,
                        x = c(
                            ...
                            this.closestPointRangePx >=
                                m.enabledThreshold * m.radius
                        );
                    if (!1 !== m.enabled || this._hasPointMarkers)
                        for (d = 0; d < a.length; d++)
                            if (
                                ((e = a[d]),
                                (k = (f = e.graphic) ? "animate" : "attr"),
                                (p = e.marker || {}),
                                (h = !!e.marker),
                                (g = (x && void 0 === p.enabled) || p.enabled),
                                (n = !1 !== e.isInside),
                                g && !e.isNull)
                            ) {
                                ...
                                f
                                    ? f[n ? "show" : "hide"](!0).animate(q)
                                    : n &&
                                      (0 < q.width || e.hasImage) &&
                ...
                drawGraph: function () {
                    ...
                    e.forEach(function (f, e) {
                        var l = f[0],
                            ...
                            k = g ? "animate" : "attr";
                        g
                            ? ((g.endX = a.preventGraphAnimation
                                  ? null
                                  : c.xMap),
                              g.animate({ d: c }))
                            : c.length &&
                              (a[l] = g = a.chart.renderer
                                  .path(c)
                                  .addClass(f[1])
                                  .attr({ zIndex: 1 })
                                  .add(a.group));
                        ...
                        ? ((x = w.reversed),
                          ...
                          e.forEach(function (e, l) {
                              ...
                              f = Math.min(
                                  Math.max(
                                      Math.round(
                                          w.toPixels(c(e.value, q.max), !0) || 0
                                      ),
                                      0
                                  ),
                                  n
                          ...
                          (this.clips = k))
                        : a.visible && (p && p.show(!0), h && h.show(!0));
                },
                ...
                plotGroup: function (a, b, c, d, e) {
                    ...
                    f.attr({ visibility: c })[l ? "attr" : "animate"](
                        this.getPlotBox()
                    );
                    return f;
                },
                ...
                pointPlacementToXValue: function () {
                    ...
                    m(a) &&
                        (a *= c(
                            this.options.pointRange || this.xAxis.pointRange
                        ));
                    return a;
                },
            }
    ...
    J(G, "parts/Stacking.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.StackItem = function (a, e, d, m, b) {
            ...
            this.alignOptions = {
                ...
                verticalAlign:
                    e.verticalAlign || (g ? "middle" : d ? "bottom" : "top"),
                y: u(e.y, g ? 4 : d ? 14 : -6),
                x: u(e.x, g ? (d ? -6 : 6) : 0),
            };
            this.textAlign =
                e.textAlign || (g ? (d ? "right" : "left") : "center");
        };
        a.StackItem.prototype = {
            ...
            setOffset: function (a, e, d, m) {
                var b = this.axis,
                    g = b.chart;
                m = b.translate(
                    b.usePercentage ? 100 : m ? m : this.total,
                    0,
                    0,
                    0,
                    1
                ...
                (e = this.label) &&
                    ...
                    (b = e.alignAttr),
                    e[
                        !1 === this.options.crop || g.isInsidePlot(b.x, b.y)
                            ? "show"
                            : "hide"
                    ](!0));
            },
        ...
        v.prototype.setStackedPoints = function () {
            if (
                ...
                for (f = 0; f < m; f++)
                    (r = e[f]),
                        (E = g[f]),
                        (D = this.getStackIndicator(D, r, this.index)),
                        (I = D.key),
                        (z = (A = w && E < (p ? 0 : k)) ? t : q),
                        C[z] || (C[z] = {}),
                        C[z][r] ||
                            (l[z] && l[z][r]
                                ? ((C[z][r] = l[z][r]), (C[z][r].total = null))
                                : (C[z][r] = new a.StackItem(
                                      v,
                        ...
                        (z = C[z][r]),
                        null !== E
                            ? ((z.points[I] = z.points[this.index] = [
                                  u(z.cumulative, p),
                              ]),
                              h(z.cumulative) || (z.base = I),
                              (z.touched = v.stacksTouched),
                              0 < D.index &&
                                  !1 === this.singleStacks &&
                                  (z.points[I][0] =
                                      z.points[this.index + "," + r + ",0"][0]))
                            : (z.points[I] = z.points[this.index] = null),
                        "percent" === b
                            ? ((A = A ? q : t),
                              w && C[A] && C[A][r]
                                  ? ((A = C[A][r]),
                                    (z.total = A.total =
                                        Math.max(A.total, z.total) +
                                            Math.abs(E) || 0))
                                  : (z.total = B(z.total + (Math.abs(E) || 0))))
                            : (z.total = B(z.total + (E || 0))),
                        (z.cumulative = u(z.cumulative, p) + (E || 0)),
                        null !== E &&
                            (z.points[I].push(z.cumulative),
                            (d[f] = z.cumulative));
            ...
            a[k + "Stacker"] &&
                [e, "-" + e].forEach(function (e) {
                    for (var c = m.length, g, p; c--; )
                        if (
                            ((g = m[c]),
                            (b = a.getStackIndicator(b, g, a.index, e)),
                            (p = (g = d[e] && d[e][g]) && g.points[b.key]))
                        )
                            a[k + "Stacker"](p, g, c);
                });
        };
    ...
    J(G, "parts/Dynamics.js", [G["parts/Globals.js"]], function (a) {
        ...
        a.cleanRecursively = function (b, c) {
            var e = {};
            k(b, function (g, l) {
                if (d(b[l], !0) && !b.nodeType && c[l])
                    (g = a.cleanRecursively(b[l], c[l])),
                        Object.keys(g).length && (e[l] = g);
            ...
            update: function (c, d, e, m) {
                ...
                if ((f = c.chart)) {
                    ...
                    if ("inverted" in f || "polar" in f || "type" in f)
                        l.propFromSeries(), (r = !0);
                    "alignTicks" in f && (r = !0);
                    k(f, function (a, b) {
                        -1 !==
                            l.propsRequireUpdateSeries.indexOf("chart." + b) &&
                            (w = !0);
                        -1 !== l.propsRequireDirtyBox.indexOf(b) &&
                            (l.isDirtyBox = !0);
                ...
                this.collectionsWithUpdate.forEach(function (a) {
                    ...
                    c[a] &&
                        ...
                        F(c[a]).forEach(function (c, d) {
                            ...
                            !d &&
                                e &&
                                l.collectionsWithInit[a] &&
                                (l.collectionsWithInit[a][0].apply(
                                    l,
                                    [c]
                                        .concat(
                                            l.collectionsWithInit[a][1] || []
                                        )
                                        .concat([!1])
                                ).touched = !0);
                        }),
                ...
                getStackPoints: function (e) {
                    ...
                    if (this.options.stacking) {
                        for (c = 0; c < e.length; c++)
                            (e[c].leftNull = e[c].rightNull = null),
                                (g[e[c].x] = e[c]);
                ...
                drawGraph: function () {
                    ...
                    u.forEach(function (e) {
                        ...
                        a.chart.styledMode ||
                            (m.fill = H(
                                e[3],
                                E(e[2]).setOpacity(H(t.fillOpacity, 0.75)).get()
                            ));
                        g[d](m);
                        g.startX = h.xMap;
            ...
            {},
            {
                getPointSpline: function (a, B, h) {
                    ...
                    if (
                        ...
                        g += d;
                        v > a && v > q
                            ? ((v = Math.max(a, q)), (g = 2 * q - v))
                            : v < a &&
                              v < q &&
                              ((v = Math.min(a, q)), (g = 2 * q - v));
                        g > h && g > q
                            ? ((g = Math.max(h, q)), (v = 2 * q - g))
                            : g < h &&
                              g < q &&
                              ((g = Math.min(h, q)), (v = 2 * q - g));
                        B.rightContX = n;
                        B.rightContY = g;
                    }
                    B = [
                        "C",
                        E(t.rightContX, t.plotX),
                        E(t.rightContY, t.plotY),
                        E(u, e),
                        E(v, q),
                        e,
                        q,
            ...
            },
            {
                    ...
                    a.points.forEach(function (b) {
                        ...
                        n &&
                            ...
                            b.y === p &&
                                ...
                                (u = !u),
                            (x =
                                Math.abs(x - c) > n ? e - n : c - (u ? n : 0)));
                        h(b.options.pointWidth) &&
                            ((f = q = Math.ceil(b.options.pointWidth)),
                            (m -= Math.round((f - w) / 2)));
                        b.barX = m;
                        b.pointWidth = f;
                        b.tooltipPos = d.inverted
                            ? [
                                  k.len + k.pos - d.plotLeft - g,
                                  a.xAxis.len - m - q / 2,
                                  A,
                              ]
                            : [m + q / 2, g + k.pos - d.plotTop, A];
                        b.shapeType =
                            a.pointClass.prototype.shapeType || "rect";
                        b.shapeArgs = a.crispCol.apply(
                            a,
                            b.isNull ? [m, c, q, 0] : [m, x, q, A]
                        );
                    });
                },
                getSymbol: a.noop,
                ...
                pointAttribs: function (a, d) {
                    ...
                    a &&
                        this.zones.length &&
                        ((u = a.getZone()),
                        (c = a.options.color || (u && u.color) || this.color),
                        u &&
                            ((h = u.borderColor || h),
                            (k = u.dashStyle || k),
                            (n = u.borderWidth || n)));
                ...
                drawPoints: function () {
                    ...
                    a.points.forEach(function (c) {
                        ...
                        if (e(c.plotY) && null !== c.y) {
                            h = c.shapeArgs;
                            g &&
                                g.element.nodeName !== c.shapeType &&
                                (g = g.destroy());
                            if (g) g[p](q(h));
                            else
                                c.graphic = g = b[c.shapeType](h).add(
                                    c.group || a.group
                                );
                            ...
                            ["x", "y"].forEach(function (u, v) {
                                ...
                                h[u] &&
                                    ...
                                    n &&
                                        !n.isLog &&
                                        ((d = Math.max(0, q[g] - m)),
                                        (n = Math.min(n.len, q[g] + m)),
                                        (v = 1e4 * Math.sin(t + v * e)),
                                        (q[g] =
                                            d + (n - d) * (v - Math.floor(v))),
            ...
            },
            {
                    ...
                    for (A = 0; A < z; A++) {
                        ...
                        B.labelDistance = t(
                            B.options.dataLabels &&
                                B.options.dataLabels.distance,
                            v
                        );
                        B.labelDistance = a.relativeLength(
                            B.labelDistance,
                            B.shapeArgs.r
                        );
                        ...
                        C = (Math.cos(n) * d[2]) / 2;
                        l = (Math.sin(n) * d[2]) / 2;
                        B.tooltipPos = [d[0] + 0.7 * C, d[1] + 0.7 * l];
                ...
                drawPoints: function () {
                    ...
                    this.points.forEach(function (d) {
                        d.graphic ||
                            ((d.graphic = a[d.shapeType](d.shapeArgs).add(
                                d.series.group
                            )),
            ...
            },
            {
                ...
                setVisible: function (a, e) {
                    ...
                    a !== b.visible &&
                        ...
                        b.legendItem && g.legend.colorizeItem(b, a),
    ...
    J(G, "parts/DataLabels.js", [G["parts/Globals.js"]], function (a) {
            ...
            for (
                ...
                for (h = !1; k--; )
                    0 < k &&
                        ...
                        ((b[k - 1].size += b[k].size),
                        (b[k - 1].targets = b[k - 1].targets.concat(
                            b[k].targets
                        )),
                        (b[k - 1].align = 0.5),
                        b[k - 1].pos + b[k - 1].size > d &&
                            (b[k - 1].pos = d - b[k - 1].size),
                        b.splice(k, 1),
                        (h = !0));
            }
            m.push.apply(m, p);
            ...
            b.some(function (b) {
                ...
                if (
                    b.targets.some(function () {
                        m[k].pos = b.pos + c;
                        if (Math.abs(m[k].pos - m[k].target) > e)
                            return (
                                m.slice(0, k + 1).forEach(function (a) {
                                    delete a.pos;
                                }),
                                (m.reducedLen = (m.reducedLen || d) - 0.1 * d),
                                m.reducedLen > 0.1 * d && a.distribute(m, d, e),
                                !0
                            );
                        c += m[k].size;
                        k++;
            ...
            var p = this,
                ...
                q = g(
                    g(
                        ...
                        c.options.plotOptions &&
                            c.options.plotOptions[p.type] &&
                            c.options.plotOptions[p.type].dataLabels
                    ),
                    q
                );
            a.fireEvent(this, "drawDataLabels");
            if (d(q) || q.enabled || p._hasPointLabels)
                (l = p.plotGroup(
                    "dataLabelsGroup",
                    "data-labels",
                    z && !C ? "hidden" : "inherit",
                        ...
                        u.forEach(function (e, f) {
                            ...
                            !r || (g && H(k))
                                ? g &&
                                  ...
                                  (r.options = e),
                                  r.attr(w),
                                  c.styledMode || r.css(m).shadow(e.shadow),
                                  r.added || r.add(l),
                                  e.textPath &&
                                      !e.useHTML &&
                                      r.setTextPath(
                                          (d.getDataLabelPath &&
                                              d.getDataLabelPath(r)) ||
                                              d.graphic,
                                          e.textPath
                                      ),
                                  p.alignDataLabel(d, r, e, null, x))
                                : ((d.dataLabel =
        ...
        v.prototype.alignDataLabel = function (a, d, e, c, g) {
            var b = this.chart,
                ...
                u =
                    this.visible &&
                    (a.series.forceDL ||
                        b.isInsidePlot(h, Math.round(m), k) ||
                        (c &&
                            b.isInsidePlot(
                                h,
            ...
            if (
                ...
                B(e, { width: l.width, height: l.height }),
                n
                    ? ((f = !1),
                      (h = b.renderer.rotCorr(p, n)),
                      (h = {
                      ...
                      d[g ? "attr" : "animate"](h).attr({ align: q }),
                      (m = (n + 720) % 360),
                      (m = 180 < m && 360 > m),
                      "left" === q
                          ? (h.y -= m ? l.height : 0)
                          : "center" === q
                          ? ((h.x -= l.width / 2), (h.y -= l.height / 2))
                          : "right" === q &&
                            ((h.x -= l.width), (h.y -= m ? 0 : l.height)),
                      (d.placed = !0),
                      (d.alignAttr = h))
                    : (d.align(e, null, c), (h = d.alignAttr)),
                f && 0 <= c.height
                    ...
                    : t(e.crop, !0) &&
                      (u =
                          b.isInsidePlot(h.x, h.y) &&
                          b.isInsidePlot(h.x + l.width, h.y + l.height)),
                e.shape && !n)
            )
                d[g ? "attr" : "animate"]({
        ...
        v.prototype.justifyDataLabel = function (a, d, e, c, g, h) {
            ...
            l = e.x + n;
            0 > l &&
                ("right" === k ? (d.align = "left") : (d.x = -l), (p = !0));
            l = e.x + c.width - n;
            l > b.plotWidth &&
                ("left" === k ? (d.align = "right") : (d.x = b.plotWidth - l),
                (p = !0));
            l = e.y + n;
            0 > l &&
                ("bottom" === m ? (d.verticalAlign = "top") : (d.y = -l),
                (p = !0));
            l = e.y + c.height - n;
            l > b.plotHeight &&
                ("top" === m
        ...
        n.pie &&
            ((n.pie.prototype.dataLabelPositioners = {
                radialDistributionY: function (a) {
                    return a.top + a.distributeBox.pos;
                },
                radialDistributionX: function (a, d, e, c) {
                    return a.getX(
                        e < d.top + 2 || e > d.bottom - 2 ? c : e,
                        d.half,
                        d
                    );
                },
            ...
            (n.pie.prototype.drawDataLabels = function () {
                ...
                b.visible &&
                    ...
                    M.forEach(function (d, e) {
                        ...
                        if (n)
                            for (
                                ...
                                w &&
                                    H(g.distributeBox) &&
                                    (void 0 === g.distributeBox.pos
                                        ? (S = "hidden")
                                        : ((L = g.distributeBox.size),
                                          (y = T.radialDistributionY(g))));
                                delete g.positionIndex;
                                if (h.justify) J = T.justify(g, B, z);
                                else
                                    switch (h.alignTo) {
                                        case "connectors":
                    ...
                    0 === E(P) || this.verifyDataLabelOverflow(P)) &&
            ...
            (n.pie.prototype.alignDataLabel = q),
            (n.pie.prototype.verifyDataLabelOverflow = function (a) {
                ...
                h ||
                    (null !== c[0]
                        ? (g = Math.max(b[2] - Math.max(a[1], a[3]), e))
                        : ((g = Math.max(b[2] - a[1] - a[3], e)),
                          (b[0] += (a[3] - a[1]) / 2)),
                    null !== c[1]
                        ? (g = Math.max(
                              Math.min(g, b[2] - Math.max(a[0], a[2])),
                              e
                          ))
                        : ((g = Math.max(Math.min(g, b[2] - a[0] - a[2]), e)),
                          (b[1] += (a[0] - a[2]) / 2)),
                    g < b[2]
                        ? ((b[2] = g),
                          (b[3] = Math.min(u(d.innerSize || 0, g), g)),
                          this.translate(b),
        ...
        n.column &&
            (n.column.prototype.alignDataLabel = function (a, d, g, c, h) {
                var b = this.chart.inverted,
                    k = a.series,
                    m = a.dlBox || a.shapeArgs,
                    n = t(
                        a.below,
                        a.plotY > t(this.translatedThreshold, k.yAxis.len)
                    ),
                    l = t(g.inside, !!this.options.stacking);
                m &&
                    ((c = e(m)),
                    0 > c.y && ((c.height += c.y), (c.y = 0)),
                    (m = c.y + c.height - k.yAxis.len),
                    0 < m && (c.height -= m),
                    b &&
                        (c = {
                    ...
                    l ||
                        (b
                            ? ((c.x += n ? 0 : c.width), (c.width = 0))
                            : ((c.y += n ? c.height : 0), (c.height = 0))));
                g.align = t(g.align, !b || l ? "center" : n ? "right" : "left");
                g.verticalAlign = t(
                    g.verticalAlign,
                    b || l ? "middle" : n ? "top" : "bottom"
                );
        ...
        J = a.TrackerMixin = {
                ...
                a._hasTracking ||
                    (a.trackerGroups.forEach(function (e) {
                        if (a[e]) {
                            ...
                            !b.styledMode &&
                                a.options.cursor &&
                                a[e].css(h).css({ cursor: a.options.cursor });
                        }
                    }),
                    (a._hasTracking = !0));
            ...
            drawTrackerGraph: function () {
                var a = this,
                    ...
                    q = "rgba(192,192,192," + (x ? 0.0001 : 0.002) + ")";
                if (e && !c)
                    for (n = e + 1; n--; )
                        "M" === d[n] &&
                            d.splice(n + 1, 0, d[n + 1] - f, d[n + 2], "L"),
                            ((n && "M" === d[n]) || n === e) &&
                                d.splice(n, 0, "L", d[n - 2] + f, d[n - 1]);
                m
                    ? m.attr({ d: d })
                    : a.graph &&
                      ((a.tracker = h
            ...
            setItemEvents: function (a, b, c) {
                ...
                (c ? b : a.legendGroup)
                    ...
                    .on("mouseout", function () {
                        d.styledMode ||
                            b.css(
                                m(a.visible ? d.itemStyle : d.itemHiddenStyle)
                            );
                        d.allItems.forEach(function (b) {
                            a !== b && b.setState("", !g);
                        });
            ...
            showResetZoom: function () {
                ...
                u(this, "beforeShowResetZoom", null, function () {
                    b.resetZoomButton = b.renderer
                        .button(c.resetZoom, null, null, a, g, k && k.hover)
                        .attr({
            ...
            zoom: function (c) {
                ...
                !c || c.resetSelection
                    ? (d.axes.forEach(function (a) {
                      ...
                      (g.initiated = !1))
                    : c.xAxis.concat(c.yAxis).forEach(function (b) {
                          var c = b.axis,
                              l = d.inverted ? c.left : c.top,
                              m = d.inverted ? l + c.width : l + c.height,
                              n = c.isXAxis,
                              p = !1;
                          if ((!n && h >= l && h <= m) || n || !a.defined(h))
                              p = !0;
                          g[n ? "zoomX" : "zoomY"] &&
                              p &&
                              ((e = c.zoom(b.min, b.max)),
                              c.displayBtn && (k = !0));
                      });
                m = d.resetZoomButton;
                k && !m
                    ? d.showResetZoom()
                    : !k && n(m) && (d.resetZoomButton = m.destroy());
                e &&
                    d.redraw(
                        b(
                ...
                u(this, "pan", { originalEvent: a }, function () {
                    ...
                    ("xy" === b ? [1, 0] : [1]).forEach(function (b) {
                        ...
                        var d = b.horiz,
                            ...
                            k = Math.min(
                                ...
                                l
                                    ? h.min
                                    : b.toValue(
                                          b.toPixels(h.min) - b.minPixelPadding
                                      )
                            ),
                            l = Math.max(
                                h.dataMax,
                                l
                                    ? h.max
                                    : b.toValue(
                                          b.toPixels(h.max) + b.minPixelPadding
                                      )
                            ),
                            n = k - f;
                        0 < n && ((m += n), (f = k));
                        ...
                        b.series.length &&
                            f !== h.min &&
                            m !== h.max &&
                            (b.setExtremes(f, m, !1, !1, { trigger: "pan" }),
                            (e = !0));
                        c[d] = g;
                    });
                    e && c.redraw(!1);
                        ...
                        c ||
                            g.getSelectedPoints().forEach(function (a) {
                                ...
                                a.selected &&
                                    ...
                                    (b.options.data[b.data.indexOf(a)] =
                                        a.options),
                                    a.setState(
                                        g.hoverPoints &&
                ...
                if (
                    ...
                    if (this.graphic)
                        k && this.graphic.removeClass("highcharts-point-" + k),
                            ...
                            x.styledMode ||
                                ((E = g.pointAttribs(this, a)),
                                (F = b(x.options.chart.animation, h.animation)),
                        ...
                        if (a && n) {
                            ...
                            if (w)
                                w[c ? "animate" : "attr"]({ x: y.x, y: y.y });
                            else
                                k &&
                                    ((g.stateMarkerGraphic = w = x.renderer
                                        .symbol(k, y.x, y.y, y.width, y.height)
                                        .add(g.markerGroup)),
                                    (w.currentSymbol = k));
                            !x.styledMode &&
                                w &&
                                w.attr(g.pointAttribs(this, a));
                        }
                        w &&
                            (w[
                                a && x.isInsidePlot(d, e, x.inverted)
                                    ? "show"
                                    : "hide"
                            ](),
                    ...
                    (a = h.halo) && a.size
                        ? (B ||
                              (g.halo = B = x.renderer
                                  .path()
                                  .add((this.graphic || w).parentGroup)),
                        ...
                        : B &&
                          B.point &&
                          B.point.haloPath &&
                          B.animate({ d: B.point.haloPath(0) }, null, B.hide);
        ...
        t(p.prototype, {
            ...
            setState: function (a, c) {
                ...
                if (
                    ...
                    if (g && !g.dashstyle)
                        for (
                            h = { "stroke-width": m }, g.animate(h, n);
                            d["zone-graph-" + e];
    ...
    J(G, "parts/Responsive.js", [G["parts/Globals.js"]], function (a) {
        ...
        E.prototype.setResponsive = function (e, h) {
            ...
            t = t.toString() || void 0;
            t !== (n && n.ruleIds) &&
                (n && this.update(n.undoOptions, e, !0),
                t
            ...
            function t(n, g, d, m) {
                ...
                a.objectEach(n, function (a, n) {
                    if (!m && -1 < u.collectionsWithUpdate.indexOf(n))
                        for (a = e(a), d[n] = [], b = 0; b < a.length; b++)
                            g[n][b] &&
                                ((d[n][b] = {}),
                                t(a[b], g[n][b], d[n][b], m + 1));
                    else
                        B(a)
                            ? ((d[n] = G(a) ? [] : {}),
                              t(a, g[n] || {}, d[n], m + 1))

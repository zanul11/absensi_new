...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/highcharts-more", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
    ...
    _registerModule(
        ...
        function (H) {
            ...
            extend(Pane.prototype, {
                coll: "pane", // Student of chart.pane
                    ...
                    if (backgroundOption) {
                        ...
                        for (i = 0; i < len; i++) {
                            ...
                            if (backgroundOption[i] && this.axis) {
                                ...
                                this.background[i] = this.background[
                                    i
                                ].destroy();
            ...
            radialAxisMixin = {
                ...
                getPlotLinePath: function (options) {
                    ...
                    if (axis.isCircular) {
                        ...
                        axis.options.gridLineInterpolation === "circle"
                    ) {
                    ...
                    chart.labelCollectors.push(function () {
                        if (
                            ...
                            return axis.tickPositions
                                .map(function (pos) {
                                    return (
                                        axis.ticks[pos] && axis.ticks[pos].label
                                    );
                                })
            ...
            addEvent(Tick, "afterGetLabelPosition", function (e) {
                ...
                if (axis.isRadial) {
                    ...
                    if (
                        ...
                        label.translate(
                            translateX,
                            translateY + labelYPosCorrection
                        );
                    }
                ...
                },
                {
                    ...
                    getGraphPath: function (points) {
                        var highPoints = [],
                            ...
                            i,
                            getGraphPath =
                                seriesTypes.area.prototype.getGraphPath,
                            point,
                            pointShim,
                            linePath,
                            lowerPath,
                        ...
                        higherAreaPath = getGraphPath.call(
                            this,
                            highAreaPoints
                        );
                        options.step = step;
                    ...
                    drawDataLabels: function () {
                        ...
                        if (isArray(dataLabelOptions)) {
                            ...
                            upperDataLabelOptions = extend(
                                {},
                                dataLabelOptions
                            ); // Make copy;
                            upperDataLabelOptions.x = dataLabelOptions.xHigh;
                            upperDataLabelOptions.y = dataLabelOptions.yHigh;
                            lowerDataLabelOptions = extend(
                                {},
                                dataLabelOptions
                            ); // Make copy
                        ...
                        if (
                            ...
                            while (i--) {
                                ...
                                if (point) {
                                    ...
                                    if (inverted) {
                                        ...
                                        if (
                                            !upperDataLabelOptions.verticalAlign
                                        ) {
                            ...
                            if (seriesProto.drawDataLabels) {
                                seriesProto.drawDataLabels.apply(
                                    this,
                                    arguments
                                ); // #1209
                            }
                            ...
                            while (i--) {
                                ...
                                if (point) {
                                    ...
                                    if (inverted) {
                                        ...
                                        if (
                                            !lowerDataLabelOptions.verticalAlign
                                        ) {
                    ...
                    drawPoints: function () {
                        ...
                        while (i < pointLength) {
                            ...
                            point.y = point.high;
                            point.negative =
                                point.high < (series.options.threshold || 0);
                ...
                },
                {
                    setState: function () {
                        ...
                        if (!defined(this.plotHigh)) {
                            ...
                            this.plotHigh = series.yAxis.toPixels(
                                this.high,
                                true
                            );
                        }
                        ...
                        if (!defined(this.plotLow)) {
                            ...
                            this.plotLow = this.plotY = series.yAxis.toPixels(
                                this.low,
                                true
                            );
                        }
                        ...
                        if (series.stateMarkerGraphic) {
                            series.lowerStateMarkerGraphic =
                                series.stateMarkerGraphic;
                            series.stateMarkerGraphic =
                                series.upperStateMarkerGraphic;
                        }
                    ...
                    destroyElements: function () {
                        ...
                        return pointProto.destroyElements.apply(
                            this,
                            arguments
                        );
                    },
                ...
                ),
                {
                    ...
                    translate: function () {
                        var series = this,
                            ...
                            safeDistance =
                                Math.max(chart.chartWidth, chart.chartHeight) +
                                999,
                            plotHigh;
                        ...
                        function safeBounds(pixelPos) {
                            return Math.min(
                                Math.max(-safeDistance, pixelPos),
                                safeDistance
                            );
                        }
                        ...
                        series.points.forEach(function (point) {
                            ...
                            y = plotHigh;
                            height =
                                pick(point.rectPlotY, point.plotY) - plotHigh;
                    ...
                    translate3dPoints: function () {
                        return colProto.translate3dPoints.apply(
                            this,
                            arguments
                        );
                    },
                    translate3dShapes: function () {
                        return colProto.translate3dShapes.apply(
                            this,
                            arguments
                        );
                    },
                ...
                {},
                {
                    ...
                    translate: function () {
                        var series = this,
                            ...
                            dense = (series.dense =
                                series.closestPointRange * series.xAxis.transA <
                                2),
                            ...
                            pointXOffset = (series.pointXOffset =
                                metrics.offset);
                     ...
                     */
                            ...
                            if (chart.inverted) {
                                ...
                                // proportion tanges
                                topXwidth =
                                    (barW * (topPointY - invBarPos)) /
                                    stackHeight;
                                bottomXwidth =
                                    (barW * (topPointY - (invBarPos - barH))) /
                                    stackHeight;
                    ...
                    translate: function () {
                        ...
                        series.points.forEach(function (point) {
                            var dialOptions = merge(options.dial, point.dial),
                                radius =
                                    (pInt(pick(dialOptions.radius, 80)) *
                                        center[2]) /
                                    200,
                                baseLength =
                                    (pInt(pick(dialOptions.baseLength, 70)) *
                                        radius) /
                                    100,
                                rearLength =
                                    (pInt(pick(dialOptions.rearLength, 10)) *
                                        radius) /
                                    100,
                    ...
                    drawPoints: function () {
                        ...
                        series.points.forEach(function (point) {
                            ...
                            if (!chart.styledMode) {
                                point.graphic[graphic ? "animate" : "attr"]({
                                    ...
                                    "stroke-width":
                                        dialOptions.borderWidth || 0,
                                    fill:
                                        dialOptions.backgroundColor ||
                                        "#000000",
                                });
                            }
                        });
                        ...
                        if (pivot) {
                            ...
                            if (!chart.styledMode) {
                                series.pivot.attr({
                                    "stroke-width":
                                        pivotOptions.borderWidth || 0,
                                    stroke:
                                        pivotOptions.borderColor || "#cccccc",
                                    fill:
                                        pivotOptions.backgroundColor ||
                                        "#000000",
                                });
                            }
                        }
                        ...
                        if (!init) {
                            series.points.forEach(function (point) {
                                ...
                                if (graphic) {
                                    ...
                                    graphic.attr({
                                        rotation:
                                            (series.yAxis.startAngleRad * 180) /
                                            Math.PI,
                                    });
                    ...
                    drawPoints: function () {
                        ...
                        points.forEach(function (point) {
                            ...
                            if (point.plotY !== undefined) {
                                ...
                                if (whiskerLength) {
                                    crispCorr =
                                        (point.whiskers.strokeWidth() % 2) / 2;
                                    highPlot = highPlot + crispCorr;
                                    lowPlot = lowPlot + crispCorr;
                                    pointWiskerLength = /%$/.test(whiskerLength)
                                        ? (halfWidth *
                                              parseFloat(whiskerLength)) /
                                          100
                                        : whiskerLength / 2;
                                    point.whiskers[verb]({
                                        d: [
                                ...
                                crispCorr =
                                    (point.medianShape.strokeWidth() % 2) / 2;
                ...
                },
                {
                    ...
                    drawDataLabels: seriesTypes.arearange
                        ? function () {
                              ...
                              seriesTypes.arearange.prototype.drawDataLabels.call(
                                  this
                              );
                    ...
                    getColumnMetrics: function () {
                        return (
                            ...
                            seriesTypes.column.prototype.getColumnMetrics.call(
                                this
                            )
                        );
                    },
                ...
                },
                {
                    ...
                    translate: function () {
                        var series = this,
                            ...
                            tooltipY,
                            actualStack =
                                yAxis.waterfallStacks[series.stackKey],
                            actualStackX,
                            dummyStackItem,
                            total,
                            pointY,
                        ...
                        for (i = 0, len = points.length; i < len; i++) {
                            ...
                            if (stacking) {
                                ...
                                // up points
                                y =
                                    Math.max(previousY, previousY + pointY) +
                                    range[0];
                            ...
                            tooltipY =
                                point.plotY +
                                (point.negative ? shapeArgs.height : 0);
                    ...
                    getCrispPath: function () {
                        var data = this.data,
                            ...
                            length = data.length,
                            graphNormalizer =
                                (Math.round(this.graph.strokeWidth()) % 2) / 2,
                            borderNormalizer =
                                (Math.round(this.borderWidth) % 2) / 2,
                        ...
                        for (i = 1; i < length; i++) {
                            ...
                            if (prevStack) {
                                ...
                                d = [
                                    "M",
                                    prevArgs.x +
                                        (reversedXAxis ? 0 : prevArgs.width),
                                    yPos,
                                    "L",
                                    pointArgs.x +
                                        (reversedXAxis ? pointArgs.width : 0),
                                    yPos,
                                ];
                            }
                        ...
                        if (stacking) {
                            ...
                            if (stacking === "overlap") {
                                objectEach(
                                    ...
                                    function (stackX) {
                                        stackedYNeg.push(
                                            arrayMin(stackX.stackState)
                                        );
                                        stackedYPos.push(
                                            arrayMax(stackX.stackState)
                                        );
                                    }
                                );
                            } else {
                                objectEach(
                                    ...
                                    function (stackX) {
                                        stackedYNeg.push(
                                            stackX.negTotal + stackX.threshold
                                        );
                                        stackedYPos.push(
                                            stackX.posTotal + stackX.threshold
                                        );
                                    }
                                );
                            }
        ...
        function (H) {
            ...
            seriesType(
                ...
                },
                {
                    type: "polygon",
                    getGraphPath: function () {
                        var graphPath = Series.prototype.getGraphPath.call(
                                this
                            ),
        ...
        function (H) {
            ...
            H.BubbleLegend.prototype = {
                ...
                drawLegendSymbol: function (legend) {
                    ...
                    this.movementX =
                        options.labels.align === "left" ? connectorSpace : 0;
                ...
                setOptions: function () {
                    ...
                    ranges.forEach(function (range, i) {
                        ...
                        ranges[i] = merge(ranges[i], {
                            center:
                                ranges[0].radius - ranges[i].radius + baseline,
                        });
                ...
                renderRange: function (range) {
                    var mainRange = this.ranges[0],
                        ...
                        labelMovement =
                            fontSize / 2 - (fontMetrics.h - fontSize) / 2,
                        crispMovement =
                            (posY % 1 ? 1 : 0.5) -
                ...
                getMaxLabelSize: function () {
                    ...
                    labels.forEach(function (label) {
                        ...
                        if (maxLabel) {
                            maxLabel =
                                labelSize.width > maxLabel.width
                                    ? labelSize
                                    : maxLabel;
                        } else {
                            maxLabel = labelSize;
                ...
                predictBubbleSizes: function () {
                    var chart = this.chart,
                        ...
                        lastLineHeight = horizontal
                            ? chart.legend.lastLineHeight
                            : 0,
                    ...
                    if (floating || !/%$/.test(maxSize)) {
                        ...
                        calculatedSize =
                            ((plotSize + lastLineHeight - fontMetrics.h / 2) *
                                maxSize) /
                            100 /
                            (maxSize / 100 + 1);
                        ...
                        if (
                            (horizontal &&
                                plotSizeY - calculatedSize >= plotSizeX) ||
                            (!horizontal &&
                                plotSizeX - calculatedSize >= plotSizeY)
                        ) {
                            calculatedSize = maxPxSize;
                        }
                    }
                ...
                correctSizes: function () {
                    ...
                    if (
                        Math.abs(
                            Math.ceil(bubbleSeriesSize) - bubbleLegendSize
                        ) > 1
                    ) {
                        this.updateRanges(
            ...
            wrap(
                ...
                function (proceed, options, callback) {
                    ...
                    if (
                        ...
                        legend.bubbleLegend.updateRanges(
                            bubbleSizes[0],
                            bubbleSizes[1]
                        );
                ...
                },
                {
                    ...
                    pointAttribs: function (point, state) {
                        var markerOptions = this.options.marker,
                            ...
                            attr = Series.prototype.pointAttribs.call(
                                this,
                                point,
                                state
                            );
                    ...
                    getRadius: function (zMin, zMax, minSize, maxSize, value) {
                        ...
                        if (!isNumber(value)) {
                            ...
                            radius =
                                Math.ceil(minSize + pos * (maxSize - minSize)) /
                                2;
                        }
                        return radius;
                    },
            ...
            Axis.prototype.beforePadding = function () {
                ...
                if (activeSeries.length && range > 0 && !this.isLog) {
                    ...
                    [
                        ...
                        if (
                            pick(axis.options[keys[0]], axis[keys[1]]) ===
                            undefined
                        ) {
        ...
        function (H) {
            ...
            H.networkgraphIntegrations = {
                verlet: {
                     ...
                     */
                    barycenter: function () {
                        var gravitationalConstant = this.options
                    ...
                    attractive: function (link, force, distanceXY) {
                        var massFactor = link.getMass(),
                            translatedX =
                                -distanceXY.x * force * this.diffTemperature,
                            translatedY =
                                -distanceXY.y * force * this.diffTemperature;

                        if (!link.fromNode.fixedPosition) {
                            link.fromNode.plotX -=
                                (translatedX * massFactor.fromNode) /
                                link.fromNode.degree;
                            link.fromNode.plotY -=
                                (translatedY * massFactor.fromNode) /
                                link.fromNode.degree;
                        }
                        if (!link.toNode.fixedPosition) {
                            link.toNode.plotX +=
                                (translatedX * massFactor.toNode) /
                                link.toNode.degree;
                            link.toNode.plotY +=
                                (translatedY * massFactor.toNode) /
                                link.toNode.degree;
                        }
                    },
                    /**
                    ...
                    integrate: function (layout, node) {
                        var friction = -layout.options.friction,
                            ...
                            // Apply friciton:
                            diffX =
                                (node.plotX + node.dispX - prevX) * friction,
                            diffY =
                                (node.plotY + node.dispY - prevY) * friction,
                            abs = Math.abs,
                    ...
                    getK: function (layout) {
                        return Math.pow(
                            (layout.box.width * layout.box.height) /
                                layout.nodes.length,
                            0.5
                        );
                    },
            ...
            H.extend(
                ...
                /** @lends Highcharts.QuadTreeNode.prototype */
                {
                    ...
                    getBoxPosition: function (node) {
                        var left =
                                node.plotX < this.box.left + this.box.width / 2,
                            top =
                                node.plotY < this.box.top + this.box.height / 2,
                            index;
            ...
            H.extend(
                ...
                H.layouts["reingold-fruchterman"].prototype,
                {
                    ...
                    */
                        // Limit X-coordinates:
                        node.plotX = Math.max(
                            Math.min(node.plotX, box.width - radius),
                            box.left + radius
                        );

                        // Limit Y-coordinates:
                        node.plotY = Math.max(
                            Math.min(node.plotY, box.height - radius),
                            box.top + radius
                        );
                    },
                    /**
                ...
                onMouseMove: function (point, event) {
                    if (point.fixedPosition && point.inDragMode) {
                        var series = this,
                            ...
                            diffX =
                                point.fixedPosition.chartX -
                                normalizedEvent.chartX,
                            diffY =
                                point.fixedPosition.chartY -
                ...
                },
                {
                    ...
                    setVisible: function () {
                        ...
                        if (series.parentNodeLayout && series.graph) {
                            if (series.visible) {
                                ...
                                series.graph.hide();
                                series.parentNodeLayout.removeNode(
                                    series.parentNode
                                );
                                if (series.parentNode.dataLabel) {
                    ...
                    drawDataLabels: function () {
                        ...
                        if (this.parentNode) {
                            ...
                            Series.prototype.drawDataLabels.apply(
                                this,
                                arguments
                            );
                    ...
                    seriesBox: function () {
                        ...
                        return H.isNumber(bBox.width / bBox.height)
                            ? bBox
                            : null;
                    },
                    /**
                    ...
                    calculateParentRadius: function () {
                        ...
                        series.parentNodeRadius = Math.min(
                            Math.max(
                                Math.sqrt(
                    ...
                    drawGraph: function () {
                        ...
                        var series = this,
                            chart = series.chart,
                            parentAttribs = {},
                            nodeMarker = this.layout.options.parentNodeOptions
                                .marker,
                            parentOptions = {
                                fill:
                        ...
                        parentAttribs = H.merge(
                            {
                                x:
                                    series.parentNode.plotX -
                                    series.parentNodeRadius,
                                y:
                                    series.parentNode.plotY -
                                    series.parentNodeRadius,
                    ...
                    addSeriesLayout: function () {
                        var series = this,
                            ...
                            graphLayoutsStorage =
                                series.chart.graphLayoutsStorage,
                            graphLayoutsLookup =
                                series.chart.graphLayoutsLookup,
                            parentNodeOptions = H.merge(
                                layoutOptions,
                                layoutOptions.parentNodeOptions,
                                {
                                    enableSimulation:
                                        series.layout.options.enableSimulation,
                                }
                            ),
                            parentNodeLayout;
                    ...
                    addLayout: function () {
                        ...
                        if (!layout) {
                            layoutOptions.enableSimulation = !defined(
                            ...
                            graphLayoutsStorage[
                                layoutOptions.type
                            ] = layout = new H.layouts[layoutOptions.type]();
                    ...
                    translate: function () {
                        ...
                        if (!defined(chart.allDataPoints)) {
                            chart.allDataPoints = series.accumulateAllPoints(
                                series
                            );
                    ...
                    positionBubble: function (
                        ...
                        var sqrt = Math.sqrt,
                            ...
                            gamma =
                                lastBubble[1] - newOrigin[1] < 0 ? 0 : Math.PI,
                            ...
                            posX =
                                newOrigin[0] +
                                (newOrigin[2] + nextBubble[2]) * sinA,
                            // center of new origin + (radius1 + radius2) * sinus A
                            posY =
                                newOrigin[1] -
                                (newOrigin[2] + nextBubble[2]) * cosA;
                        return [
                            posX,
                            posY,
                            nextBubble[2],
                    ...
                    placeBubbles: function (allDataPoints) {
                        ...
                        if (sortedArr.length) {
                            ...
                            series.chart.rawPositions = [].concat.apply(
                                [],
                                bubblePos
                            );

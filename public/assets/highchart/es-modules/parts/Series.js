 ...
 */ H.Series = H.seriesType(
     ...
     *         Series name
     * @sample {highmaps} maps/demo/study-map/
     *         Series name
     *
     * @type      {string}
     ...
     */
    {
         ...
         * study axis, the `pointPlacement` applies to the Y axis rather than
    ...
    /** @lends Highcharts.Series.prototype */
    {
        ...
        findPointIndex: function (optionsObject, fromIndex) {
            ...
            if (pointIndex !== -1 && pointIndex !== undefined && this.cropped) {
                pointIndex =
                ...
                for (i = 0; i < points.length; i++) {
                    ...
                    if (enabled && !point.isNull) {
                        ...
                        if (graphic) {
                            ...
                            graphic[isInside ? "show" : "hide"](true).animate(
                                markerAttribs
                            );
                        } else if (
                            isInside &&
            ...
            if (
                ...
                zones.forEach(function (threshold, i) {
                    ...
                    translatedFrom = Math.min(
                        Math.max(pick(translatedTo, translatedFrom), 0),
                        chartSizeMax
                    );
            ...
            function _search(search, tree, depth, dimensions) {
                ...
                if (tree[sideB]) {
                    ...
                    if (Math.sqrt(tdist * tdist) < ret[kdComparer]) {
                        ...
                        ret =
                            nPoint2[kdComparer] < ret[kdComparer]
                                ? nPoint2
                                : ret;
                    }
                }
        ...
        pointPlacementToXValue: function () {
            ...
            if (isNumber(pointPlacement)) {
                pointPlacement *= pick(
                    series.options.pointRange || series.xAxis.pointRange
                );
            }

    ...
    merge(colorSeriesMixin, {
        ...
        drawPoints: function () {
            ...
            if (!series.transformGroup) {
                series.transformGroup = renderer
                    .g()
                    .attr({
                        scaleX: 1,
                        scaleY: 1,
            ...
            if (series.doFullTranslate()) {
                ...
                if (chart.renderer.globalAnimation) {
                    ...
                    transformGroup.attr({ animator: 0 }).animate(
                        {
                            animator: 1,
                        },
                        {

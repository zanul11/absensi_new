    ...
    /** @lends Highcharts.InfoRegionComponent */ {
        ...
        init: function () {
                ...
                if (chart.options.accessibility.enabled) {
                    ...
                    e.html = e.html.replace(
                        ...
                        '<table tabindex="0" summary="' +
                            chart.langFormat("accessibility.tableSummary", {
                                chart: chart,
                            }) +
                            '"'
                    );
            ...
            this.addEvent(chart, "afterViewData", function (tableDiv) {
                ...
                setTimeout(function () {
                    var table =
                        tableDiv && tableDiv.getElementsByTagName("table")[0];
        ...
        onChartUpdate: function () {
            ...
            hiddenSection.setAttribute(
                "aria-label",
                chart.langFormat("accessibility.screenReaderRegionLabel", {
                    chart: chart,
                })
            );
            ...
            if (chart.getCSV && chart.options.accessibility.addTableShortcut) {
                ...
                tableShortcutAnchor.onclick =
                    chart.options.accessibility.onTableAnchorClick ||
                    function () {
                        chart.viewData();
                    };

...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/variwide", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
    ...
    _registerModule(
        ...
        function (H) {
            ...
            seriesType(
                ...
                },
                {
                    ...
                    processData: function (force) {
                        this.totalZ = 0;
                        this.relZ = [];
                        seriesTypes.column.prototype.processData.call(
                            this,
                            force
                        );
                    ...
                    /**
                     * Translate an x value inside a given study index into the distorted
                     * axis translation.
                     *
                     * @private
                    ...
                    postTranslate: function (index, x, point) {
                        var axis = this.xAxis,
                            ...
                            linearSlotRight =
                                ((i + goRight) / relZ.length) * len,
                            slotLeft = (pick(relZ[i], totalZ) / totalZ) * len,
                            slotRight =
                                (pick(relZ[i + goRight], totalZ) / totalZ) *
                                len,
                ...
                },
                {
                    isValid: function () {
                        return (
                            H.isNumber(this.y, true) && H.isNumber(this.z, true)
                        );
                    },
                }
            );
            ...
            /**
             * The relative width for each column. On a study axis, the widths are

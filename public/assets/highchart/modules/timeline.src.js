...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/timeline", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
            ...
            seriesType(
                 ...
                 */
                {
                    ...
                    alignDataLabel: function (point, dataLabel) {
                        ...
                        Series.prototype.alignDataLabel.apply(
                            series,
                            arguments
                        );
                    },
                    ...
                    markerAttribs: function (point, state) {
                        ...
                        if (series.xAxis.isDatetimeAxis) {
                            return seriesTypes.line.prototype.markerAttribs.call(
                                this,
                                point,
                                state
                            );
                    ...
                    bindAxes: function () {
                        ...
                        ["xAxis", "yAxis"].forEach(function (axis) {
                            // Initially set the linked xAxis type to study.
                            if (
                                axis === "xAxis" &&
                                !series[axis].userOptions.type
                            ) {
                                series[axis].categories = series[
                                    axis
                                ].hasNames = true;
                            }
                        });
                 ...
                 */
                {
                    ...
                    setVisible: function (vis, redraw) {
                        ...
                        seriesTypes.pie.prototype.pointClass.prototype.setVisible.call(
                            point,
                            vis,
                            false
                        );
                    ...
                    setState: function () {
                        var proceed =
                            Series.prototype.pointClass.prototype.setState;
    ...
    _registerModule(
        _modules,
        "masters/modules/timeline.src.js",
        [],
        function () {}
    );
});

...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/parallel-coordinates", [
            "highcharts",
        ], function (Highcharts) {
            factory(Highcharts);
    ...
    _registerModule(
        _modules,
        "modules/parallel-coordinates.src.js",
        ...
        function (H) {
            ...
            addEvent(Chart, "init", function (e) {
                ...
                if (this.hasParallelCoordinates) {
                    ...
                    for (
                        ;
                        yAxisLength <= this.parallelInfo.counter;
                        yAxisLength++
                    ) {
                        newYAxes.push({});
                    }
                ...
                /** @lends Highcharts.Axis.prototype */ {
                    ...
                    setParallelPosition: function (axisPosition, options) {
                        ...
                        if (this.chart.polar) {
                            ...
                            this[axisPosition[1]] = options[
                                axisPosition[1]
                            ] = 0;

                            // In case of chart.update(inverted), remove old options:
                            this[axisPosition[2]] = options[
                                axisPosition[2]
                            ] = null;
                            this[axisPosition[3]] = options[
                                axisPosition[3]
                            ] = null;
                        }
                    },
            ...
            function addFormattedValue(proceed) {
                ...
                if (
                    ...
                    labelFormat = pick(
                         ...
                         *    set
                         *
                         * 2. If yAxis is a study, then study name will be displayed
                         *
    ...
    _registerModule(
        _modules,
        "masters/modules/parallel-coordinates.src.js",
        [],
        function () {}
    );
});

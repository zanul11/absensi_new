...
(function (factory) {
    ...
    _registerModule(
        ...
        function (H) {
             ...
             * Note that when clicking a study label to trigger multiple series
             * drilldown, one `drilldown` event is triggered per point in the study.
             *
             ...
             */ /**
             * If a study label was clicked, which index.
             ...
             */ /**
             * If a study label was clicked, this array holds all points corresponing to
             * the study. Otherwise it is set to false.
            ...
            defaultOptions.drilldown = {
                 ...
                 * all points in the same study, equivalent to clicking the X axis
                 * label.
                 *
             ...
             * added by option, but rather loaded async. Note that when clicking a study
             * label to trigger multiple series drilldown, one `drilldown` event is
             * triggered per point in the study.
             *
             * Event arguments:
             *
             * - `study`: If a study label was clicked, which index.</dd>
             *
             ...
             *
             * - `points`: If a study label was clicked, this array holds all points
             *   corresponing to the study.</dd>
             *
            ...
            Chart.prototype.addSingleSeriesAsDrilldown = function (
                ...
                oldSeries.chart.series.forEach(function (series) {
                    if (series.xAxis === xAxis && !series.isDrilling) {
                        ...
                        series.options._colorIndex =
                            series.userOptions._colorIndex;
                ...
                newSeries = level.lowerSeries = this.addSeries(
                    ddOptions,
                    false
                );
            ...
            ColumnSeries.prototype.animateDrillupFrom = function (level) {
                var animationOptions = animObject(
                ...
                extend(PieSeries.prototype, {
                    ...
                    animateDrilldown: function (init) {
                        var level = this.chart.drilldownLevels[
                            ...
                            animationOptions = this.chart.options.drilldown
                                .animation,
                            animateFrom = level.shapeArgs,
            ...
            /**
             * Drill down to a given study. This is the same as clicking on an axis
             * label.
             *
             * @private
            ...
            H.addEvent(H.Point, "afterInit", function () {
                ...
                if (point.drilldown) {
                    ...
                    H.addEvent(point, "click", function (e) {
                        if (
                            series.xAxis &&
                            series.chart.options.drilldown

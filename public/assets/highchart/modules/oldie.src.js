...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/oldie", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
        ...
        function (H) {
            ...
            if (doc && !doc.defaultView) {
                H.getStyle = function (el, prop) {
                    ...
                    if (alias) {
                        el.style.zoom = 1;
                        return Math.max(
                            el[alias] - 2 * H.getStyle(el, "padding"),
                            0
                        );
                    }
            ...
            if (!svg) {
                ...
                H.Pointer.prototype.normalize = function (e, chartPosition) {
                    ...
                    // Get mouse position
                    if (!chartPosition) {
                        this.chartPosition = chartPosition = H.offset(
                    ...
                    return H.extend(e, {
                        ...
                        // framesets
                        chartX: Math.round(
                            Math.max(e.x, e.clientX - chartPosition.left)
                        ),
                ...
                VMLElement = {
                    ...
                    getSpanCorrection: function (
                        ...
                        var costheta = rotation
                                ? Math.cos(rotation * deg2rad)
                                : 1,
                            sintheta = rotation
                                ? Math.sin(rotation * deg2rad)
                                : 0,
                            height = pick(
                                this.elemHeight,
                ...
                VMLRendererExtension = {
                        ...
                        return extend(clipRect, {
                            ...
                            updateClipping: function () {
                                clipRect.members.forEach(function (member) {
                                    // Student.element is falsy on deleted series, like in
                    ...
                    invertChild: function (element, parentNode) {
                        var ren = this,
                            ...
                            imgStyle =
                                element.tagName === "IMG" && element.style; // #1111

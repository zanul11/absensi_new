...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/data", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
            ...
            Highcharts.extend(Data.prototype, {
                ...
                parseCSV: function (inOptions) {
                    var self = this,
                        ...
                        columns,
                        startRow =
                            typeof options.startRow !== "undefined" &&
                            options.startRow
                                ? options.startRow
                                : 0,
                ...
                */
                        ...
                        lines.some(function (columnStr, i) {
                            ...
                            for (var j = 0; j < columnStr.length; j++) {
                                ...
                                if (c === '"') {
                                    ...
                                    typeof potDelimiters[c] !== "undefined"
                                ) {
                                    token = token.trim();
                    ...
                    function deduceDateFormat(data, limit) {
                        ...
                        if (madeDeduction) {
                            ...
                            if (
                                !(options.dateFormats || self.dateFormats)[
                                    calculatedFormat
                                ]
                            ) {
                ...
                parseGoogleSpreadsheet: function () {
                    ...
                    function fetchSheet(fn) {
                        ...
                        Highcharts.ajax({
                            ...
                            error: function (xhr, text) {
                                return (
                                    options.error && options.error(text, xhr)
                                );
                            },
                        });
                    }
                ...
                parseColumn: function (column, col) {
                    var rawColumns = this.rawColumns,
                        ...
                        isXColumn =
                            this.valueCount.xColumns.indexOf(col) !== -1,
                        dateVal,
                        backup = [],
                        diff,
                        ...
                        forceCategory =
                            ...
                            ((chartOptions &&
                                chartOptions.xAxis &&
                                splat(chartOptions.xAxis)[0].type ===
                                    "category") ||
                                columnType === "string");
                    ...
                    while (row--) {
                        ...
                        if (forceCategory || (row === 0 && firstRowAsNames)) {
                            ...
                            if (
                                ...
                                if (
                                    row !== 0 &&
                                    (column.isDatetime || column.isNumeric)
                                ) {
                                    column.mixed = true;
                                }
                            }
                    ...
                    if (parseDate) {
                        ...
                        if (!match) {
                            ...
                            if (
                                ...
                                ret =
                                    match.getTime() -
                                    match.getTimezoneOffset() * 60000;

                                // Timestamp
                            } else if (isNumber(match)) {
                                ret =
                                    match -
                                    new Date(match).getTimezoneOffset() * 60000;
                            }
                        }
                    }
                    return ret;
                ...
                getFreeIndexes: function (numberOfColumns, seriesBuilders) {
                    ...
                    for (s = 0; s < seriesBuilders.length; s = s + 1) {
                        referencedIndexes = seriesBuilders[
                            s
                ...
                complete: function () {
                    ...
                    if (options.complete || options.afterComplete) {
                        ...
                        for (
                            ...
                            builder = this.valueCount.seriesBuilders[
                                seriesIndex
                            ];
                        ...
                        // Axis type is study, then the "x" column should be called
                        // "name"
                        if (type === "category") {
                            for (
                                seriesIndex = 0;
                        ...
                        Highcharts.extend(userOptions.data, {
                            afterComplete: function (dataOptions) {
                                ...
                                if (userOptions.hasOwnProperty("series")) {
                                    if (
                                        typeof userOptions.series === "object"
                                    ) {
                                        i = Math.max(

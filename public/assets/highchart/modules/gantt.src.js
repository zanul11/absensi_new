...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/gantt", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
    ...
    _registerModule(
        ...
        function (H) {
            ...
            var applyGridOptions = function applyGridOptions(axis) {
                ...
                /* Prevents adding the last tick label if the axis is not a study
               axis.
            ...
            Axis.prototype.isNavigatorAxis = function () {
                return /highcharts-navigator-[xy]axis/.test(
            ...
            Axis.prototype.isOuterAxis = function () {
                ...
                if (isOuter && isNumber(axis.columnIndex)) {
                    var columns =
                        (axis.linkedParent && axis.linkedParent.columns) ||
                        axis.columns;
                    ...
                    if (gridOptions.enabled === true) {
                        ...
                        if (!labelOpts.useHTML) {
                            ...
                            e.pos.y +=
                                ...
                                (lblMetrics.b - (lblMetrics.h - lblMetrics.f)) /
                                    2 +
                    ...
                    if (gridOptions.enabled === true) {
                        ...
                        if (this.horiz) {
                           ...
                           Into this:    |_____|_____|_____|_____|
                                            ^                 ^    */
                            options.minPadding = pick(
                                userOptions.minPadding,
                                0
                            );
                            options.maxPadding = pick(
            ...
            addEvent(
                ...
                function () {
                    var axis = this,
                        ...
                        endMoreThanMin =
                            firstPos < min && firstPos + tickInterval > min,
                        startLessThanMax =
                            lastPos > max && lastPos - tickInterval < max;
                ...
                if (gridOptions.columns) {
                    ...
                    while (++columnIndex < gridOptions.columns.length) {
                        var columnOptions = merge(
                            ...
                            {
                                linkedTo: 0,
                                // Force to behave like study axis
                                type: "category",
                            }
                        );
    ...
    _registerModule(
        ...
        function (H) {
             ...
             * scale to 24 results in each Y axis study taking up 24 pixels, and the
            ...
            var getNode = function (
                ...
                children = (mapOfIdToChildren[id] || []).map(function (child) {
                    var node = getNode(
                        ...
                        childEnd =
                            child.milestone === true ? childStart : child.end;
        ...
        function (H) {
            ...
            addEvent(Series, "afterGeneratePoints", function () {
                ...
                if (
                    xAxis &&
                    yAxis &&
                    (xAxis.options.breaks || yAxis.options.breaks)
                ) {
                    while (i--) {
                        point = points[i];
            ...
            H.Series.prototype.gappedPath = function () {
                var currentDataGrouping = this.currentDataGrouping,
                    groupingSize =
                        currentDataGrouping && currentDataGrouping.gapSize,
    ...
    _registerModule(
        ...
        function (H, Tree, mixinTreeSeries) {
            ...
            var getTickPositions = function (axis) {
                return Object.keys(axis.mapOfPosToGridNode).reduce(function (
                    arr,
                    key
                ) {
                    var pos = +key;
             ...
             * @todo It should be optional to have one study per point, or merge cells
             * @todo Add unit-tests.
             */
            var getTreeGridFromData = function (
                ...
                var categories = [],
                    ...
                    mapOfPosToGridNode = {},
                    posIterator = -1,
                    uniqueNamesEnabled = isBoolean(uniqueNames)
                        ? uniqueNames
                        : false,
                    tree,
                    treeParams,
                    ...
                    before: function (node) {
                        ...
                        if (!mapOfPosToGridNode[pos]) {
                            mapOfPosToGridNode[pos] = gridNode = {
                                depth: parentGridNode
                                    ? parentGridNode.depth + 1
                                    : 0,
                                name: name,
                                nodes: [node],
                                children: [],
                ...
                updateYValuesAndTickPos = function (map, numberOfSeries) {
                    var setValues = function (gridNode, start, result) {
                        var nodes = gridNode.nodes,
                                ...
                                start + (start === -1 ? 0 : numberOfSeries - 1),
                            diff = (end - start) / 2,
                            padding = 0.5,
                            pos = start + diff;
            ...
            override(GridAxis.prototype, {
                ...
                generateTick: function (proceed, pos) {
                    ...
                    if (isTreeGrid) {
                        ...
                        if (!tick) {
                            ticks[pos] = tick = new GridAxisTick(
                                axis,
                                pos,
                                null,
                                undefined,
            ...
            var algorithms = {
                ...
                simpleConnect: H.extend(
                    function (start, end, options) {
                        var segments = [],
                            ...
                            startObstacleIx = findObstacleFromPoint(
                                chartObstacles,
                                start
                            ),
                            endObstacleIx = findObstacleFromPoint(
                                chartObstacles,
                                end
                            ),
                            startObstacle,
                        ...
                        function getMeOut(obstacle, point, direction) {
                            var useMax =
                                abs(
                                    point[direction] -
                                        obstacle[direction + "Min"]
                                ) >
                                abs(
                                    point[direction] -
                                        obstacle[direction + "Max"]
                                );
                ...
                */
                        var dirIsX = pick(
                            ...
                            softMinX =
                                min(start.x, end.x) - metrics.maxWidth - 10,
                            softMaxX =
                                max(start.x, end.x) + metrics.maxWidth + 10,
                            softMinY =
                                min(start.y, end.y) - metrics.maxHeight - 10,
                            softMaxY =
                                max(start.y, end.y) + metrics.maxHeight + 10,
                            // Obstacles
                            chartObstacles = options.chartObstacles,
                            ...
                            endObstacleIx = findLastObstacleBefore(
                                chartObstacles,
                                softMaxX
                            );
                        ...
                        function getDodgeDirection(
                            ...
                            var softBounds = bounds.soft,
                                ...
                                minDistance = abs(
                                    obstacle[dir + "Min"] - fromPoint[dir]
                                ),
                                maxDistance = abs(
                                    obstacle[dir + "Max"] - fromPoint[dir]
                                ),
                            ...
                            minPivot =
                                pivotPoint(fromPoint, toPointMin, dirIsX)[
                                    dir
                                ] !== toPointMin[dir];
                            maxPivot =
                                pivotPoint(fromPoint, toPointMax, dirIsX)[
                                    dir
                                ] !== toPointMax[dir];
                            useMax = minPivot
                                ? maxPivot
                        ...
                        function clearPathTo(fromPoint, toPoint, dirIsX) {
                            ...
                            if (envelopingObstacle > -1) {
                                envelopingObstacle =
                                    chartObstacles[envelopingObstacle];
                        ...
                        function extractFromObstacle(
                            ...
                            var dirIsX =
                                    min(
                                        obstacle.xMax - point.x,
                                        point.x - obstacle.xMin
                                    ) <
                                    min(
                                        obstacle.yMax - point.y,
                                        point.y - obstacle.yMin
                                    ),
                                bounds = {
                            ...
                            return dirIsX
                                ? {
                                      y: point.y,
                                      x:
                                          obstacle[useMax ? "xMax" : "xMin"] +
                                          (useMax ? 1 : -1),
                                  }
                                : {
                                      x: point.x,
                                      y:
                                          obstacle[useMax ? "yMax" : "yMin"] +
                                          (useMax ? 1 : -1),
                                  };
                        }
    ...
    _registerModule(
        ...
        function (H) {
            ...
            H.SVGRenderer.prototype.symbols["triangle-left-half"] = function (
                ...
                return H.SVGRenderer.prototype.symbols["triangle-left"](
                    x,
                    y,
                    w / 2,
                    h
            ...
            Connection.prototype = {
                ...
                renderPath: function (path, attribs, animation) {
                    var connection = this,
                        ...
                        animate =
                            !chart.options.chart.forExport &&
                            animation !== false,
                        pathGraphic =
                            connection.graphics && connection.graphics.path,
                        anim;
                ...
                getPath: function (options) {
                    ...
                    if (algorithm.requiresObstacles && !chartObstacles) {
                        chartObstacles = pathfinder.chartObstacles = pathfinder.getChartObstacles(
                            options
                        );
                        ...
                        pathfinder.chartObstacleMetrics = pathfinder.getObstacleMetrics(
                            chartObstacles
                        );
                    }
                    ...
                    return algorithm(
                        // From
                        this.fromPoint.getPathfinderAnchorPoint(
                            options.startMarker
                        ),
                        // To
                ...
                render: function () {
                    ...
                    if (!defined(options.marker.radius)) {
                        options.marker.radius = min(
                            max(
                                Math.ceil((options.algorithmMargin || 8) / 2) -
                                    1,
                                1
                            ),
                            5
            ...
            Pathfinder.prototype = {
                ...
                getChartObstacles: function (options) {
                    ...
                    if (!defined(options.algorithmMargin)) {
                        calculatedMargin = options.algorithmMargin = calculateObstacleMargin(
                            obstacles
                        );
                ...
                /** @lends Point.prototype */ {
                    ...
                    getMarkerVector: function (radians, markerRadius, anchor) {
                        ...
                        if (leftOrRightRegion) {
                            ...
                            edgePoint.x +=
                                xFactor * (rectHeight / (2.0 * tanTheta));
                        ...
                        markerPoint.x =
                            edgePoint.x + markerRadius * Math.cos(theta);
                        markerPoint.y =
                            edgePoint.y - markerRadius * Math.sin(theta);
            ...
            function warnLegacy(chart) {
                if (
                    ...
                    chart.series.reduce(function (acc, series) {
                        ...
                        return (
                            acc || (series.options && series.options.pathfinder)
                        );
                    }, false)
                ) {
                    merge(
    ...
    _registerModule(
        ...
        function (H) {
            ...
            /**
             * Return color of a point based on its study.
             *
             * @private
            ...
            function getColorByCategory(series, point) {
                var colors =
                        series.options.colors || series.chart.options.colors,
                    colorCount = colors
                        ? colors.length
            ...
            seriesType(
                ...
                },
                {
                    ...
                    getColumnMetrics: function () {
                        ...
                        metrics = columnType.prototype.getColumnMetrics.call(
                            this
                        );
                    ...
                    translatePoint: function (point) {
                        ...
                        if (!inverted) {
                            ...
                            point.tooltipPos[0] = Math.max(
                                Math.min(point.tooltipPos[0], xAxis.len - 1),
                                0
                            );
                            point.tooltipPos[1] = Math.max(
                                Math.min(point.tooltipPos[1], yAxis.len - 1),
                                0
                            );
                        } else {
                            point.tooltipPos[1] +=
                            ...
                            // Limit position by the correct axis size (#9727)
                            point.tooltipPos[1] = Math.max(
                                Math.min(point.tooltipPos[1], xAxis.len - 1),
                                0
                            );
                            point.tooltipPos[0] = Math.max(
                                Math.min(point.tooltipPos[0], yAxis.len - 1),
                                0
                            );
                        }
                    ...
                    drawPoint: function (point, verb) {
                        var series = this,
                            ...
                            cutOff =
                                seriesOpts.stacking && !seriesOpts.borderRadius,
                            pointState = point.state,
                            stateOpts =
                                seriesOpts.states[pointState || "normal"] || {},
                            pointStateVerb =
                                pointState === undefined ? "attr" : verb,
                        ...
                        if (!point.isNull) {
                            ...
                            if (graphic) {
                                ...
                                point.graphicOriginal = renderer[type](
                                    merge(shapeArgs)
                                )
                                    .addClass(point.getClassName())
                            ...
                            if (partShapeArgs) {
                                if (point.graphicOverlay) {
                                    ...
                                    point.clipRect[verb](merge(clipRectArgs));
                                } else {
                                    ...
                                    point.graphicOverlay = renderer[type](
                                        partShapeArgs
                                    )
                            ...
                            if (!series.chart.styledMode) {
                                ...
                                if (partShapeArgs) {
                                    ...
                                    if (isObject(seriesOpts.partialFill)) {
                                        pfOptions = merge(
                                            pfOptions,
                                            seriesOpts.partialFill
                                        );
                                    }

                                    fill =
                                        pfOptions.fill ||
                                        color(pointAttr.fill)
                                            .brighten(-0.3)
                                            .get() ||
                                    ...
                                    pointAttr.fill = fill;
                                    point.graphicOverlay[pointStateVerb](
                                        pointAttr,
                                        animation
                                    ).shadow(seriesOpts.shadow, null, cutOff);
                                }
                ...
                },
                {
                     ...
                     * color is applied per Y axis study.
                     *
                     * @private
    ...
    _registerModule(
        ...
        function (H) {
            ...
            seriesType(
                    ...
                    tooltip: {
                        ...
                        pointFormatter: function () {
                            var point = this,
                                ...
                                xAxis = series.xAxis,
                                formats =
                                    series.tooltipOptions.dateTimeLabelFormats,
                                ...
                                retVal =
                                    "<b>" +
                                    (point.name || point.yCategory) +
                                    "</b>";

                            if (ttOptions.pointFormat) {
                                return point.tooltipFormatter(
                                    ttOptions.pointFormat
                                );
                            }
                ...
                {
                    // props - series student overrides
                    ...
                    drawPoint: function (point, verb) {
                        ...
                        if (point.options.milestone) {
                            ...
                            parent.prototype.drawPoint.call(
                                series,
                                point,
                                verb
                            );
                    ...
                    setGanttPointAliases: function (options) {
                        ...
                        addIfExists(
                            "connect",
                            pick(options.dependency, options.connect)
                        );
                    },
                },
                merge(parent.prototype.pointClass.prototype, {
                    // pointProps - point student overrides. We inherit from parent as well.
                    /**
    ...
    _registerModule(
        ...
        function (H) {
            ...
            H.ganttChart = function (renderTo, options, callback) {
                var hasRenderToArg =
                        typeof renderTo === "string" || renderTo.nodeName,
        ...
        function (H) {
            ...
            Scrollbar.prototype = {
                ...
                position: function (x, y, width, height) {
                    ...
                    if (vertical) {
                        scroller.width = scroller.yOffset = width = yOffset =
                            scroller.size;
                ...
                setRange: function (from, to) {
                    ...
                    scroller.calculatedWidth = newSize = correctFloat(
                        toPX - fromPX
                    );
                    ...
                    newPos = Math.floor(
                        fromPX + scroller.xOffset + scroller.yOffset
                    );
                ...
                initEvents: function () {
                    ...
                    scroller.mouseMoveHandler = function (e) {
                        var normalizedEvent = scroller.chart.pointer.normalize(
                                e
                            ),
                            options = scroller.options,
                    ...
                    scroller.trackClick = function (e) {
                        ...
                        if (
                            (scroller.options.vertical &&
                                normalizedEvent.chartY > top) ||
                            (!scroller.options.vertical &&
                                normalizedEvent.chartX > left)
                        ) {
            ...
            RangeSelector.prototype = {
                ...
                updateButtonStates: function () {
                    var rangeSelector = this,
                        ...
                        allButtonsEnabled =
                            rangeSelector.options.allButtonsEnabled,
                        ...
                        if (
                            ...
                            actualRange + 36e5 >=
                                { month: 28, year: 365 }[type] * day * count -
                                    offsetRange &&
                            actualRange - 36e5 <=
                                { month: 31, year: 366 }[type] * day * count +
                                    offsetRange
                        ) {
                            isSameRange = true;
                        } else if (type === "ytd") {
                            isSameRange =
                                ytdMax - ytdMin + offsetRange === actualRange;
                            isYTDButNotSelected = !isSelected;
                        } else if (type === "all") {
                            isSameRange =
                                baseAxis.max - baseAxis.min >=
                                dataMax - dataMin;
                ...
                drawInput: function (name) {
                    ...
                    function updateExtremes() {
                        var inputValue = input.value,
                            value = (options.inputDateParser || Date.parse)(
                                inputValue
                            ),
                ...
                render: function (min, max) {
                    ...
                    rangeSelector.buttonOptions.forEach(function (
                        ...
                        buttonLeft +=
                            buttons[i].width + pick(options.buttonSpacing, 5);
                    });
                    ...
                    if (inputEnabled !== false) {
                        ...
                        buttonGroupX =
                            buttonGroup.alignAttr.translateX +
                ...
                getHeight: function () {
                    ...
                    rangeSelectorHeight = rangeSelectorGroup
                        ? // 13px to keep back compatibility
                          rangeSelectorGroup.getBBox(true).height +
                          13 +
                          yPosition
                        : 0;
                ...
                titleCollision: function (chart) {
                    return !(
                        chart.options.title.text || chart.options.subtitle.text
                    );
                },
                ...
                addEvent(Chart, "beforeRender", function () {
                    ...
                    if (rangeSelector) {
                        if (isNumber(rangeSelector.deferredYTDClick)) {
                            rangeSelector.clickButton(
                                rangeSelector.deferredYTDClick
                            );
    ...
    _registerModule(
        ...
        function (H) {
            ...
            defaultSeriesType =
                seriesTypes.areaspline === undefined ? "line" : "areaspline";
            ...
            Axis.prototype.toFixedRange = function (
                ...
                var fixedRange = this.chart && this.chart.fixedRange,
                    newMin = pick(
                        fixedMin,
                        this.translate(pxMin, true, !this.horiz)
                    ),
                    newMax = pick(
                        fixedMax,
                        this.translate(pxMax, true, !this.horiz)
                    ),
            ...
            Navigator.prototype = {
                ...
                drawOutline: function (zoomedMin, zoomedMax, inverted, verb) {
                    ...
                    if (inverted) {
                        left -= halfOutline;
                        verticalMin =
                            navigatorTop + zoomedMax + outlineCorrection;
                        zoomedMax =
                            navigatorTop + zoomedMin + outlineCorrection;
                ...
                render: function (min, max, pxMin, pxMax) {
                    ...
                    if (navigator.scrollbar) {
                        if (inverted) {
                            ...
                            scrollbarHeight =
                                navigatorSize + 2 * scrollbarHeight;
                        } else {
                            scrollbarTop =
                                navigator.top +
                                (navigatorEnabled
                ...
                handlesMousedown: function (e, index) {
                    ...
                    if (index === 0) {
                        ...
                        navigator.fixedExtreme = reverse
                            ? baseXAxis.min
                            : baseXAxis.max;
                    } else {
                ...
                onMouseUp: function (e) {
                    ...
                    if (
                        ...
                        (navigator.hasDragged &&
                            (!scrollbar || !scrollbar.hasDragged)) ||
                        e.trigger === "scrollbar"
                    ) {
                        ...
                        if (navigator.zoomedMin === navigator.otherHandlePos) {
                            ...
                            navigator.zoomedMax === navigator.otherHandlePos
                        ) {
                ...
                init: function (chart) {
                    ...
                    if (navigator.navigatorEnabled) {
                        ...
                        navigator.xAxis = {
                            translate: function (value, reverse) {
                                ...
                                return reverse
                                    ? // from pixel to value
                                      (value * valueRange) / scrollTrackWidth +
                                          min
                                    : // from value to pixel
                                      (scrollTrackWidth * (value - min)) /
                                          valueRange;
                            },
                    ...
                    if (chart.options.scrollbar.enabled) {
                        ...
                        addEvent(navigator.scrollbar, "changed", function (e) {
                            ...
                            navigator.hasDragged =
                                navigator.scrollbar.hasDragged;
                ...
                updateNavigatorSeries: function (addEvents, redraw) {
                    var navigator = this,
                        ...
                        chartNavigatorSeriesOptions =
                            navigator.navigatorOptions.series,
                    ...
                    if (
                        ...
                        chartNavigatorSeriesOptions = H.splat(
                            chartNavigatorSeriesOptions
                        );
                ...
                getBaseSeriesMin: function (currentSeriesMin) {
                    return this.baseSeries.reduce(function (min, series) {
                        ...
                        return Math.min(
                            min,
                            series.xData ? series.xData[0] : min
                        );
                    }, currentSeriesMin);
                },
                ...
                modifyBaseAxisExtremes: function () {
                    var baseXAxis = this,
                        ...
                        newMin,
                        navigatorSeries =
                            navigator.series && navigator.series[0],
                ...
                updatedDataHandler: function () {
                    ...
                    navigator.stickToMax = navigator.reversedExtremes
                        ...
                        : Math.round(navigator.zoomedMax) >=
                          Math.round(navigator.size);
                    ...
                    if (navigatorSeries && !navigator.hasNavigatorData) {
                        navigatorSeries.options.pointStart =
                            baseSeries.xData[0];
                ...
                addEvent(Chart, "beforeShowResetZoom", function () {
                    ...
                    if (
                        ...
                        ((!isTouchDevice &&
                            ...
                            (isTouchDevice &&
                                chartOptions.chart.pinchType === "x"))
                    ) {
                        return false;
                    }
                });
                ...
                addEvent(Chart, "afterSetChartSize", function () {
                    ...
                    if (navigator) {
                        ...
                        if (xAxis && yAxis) {
                            ...
                            if (this.inverted) {
                                xAxis.options.left = yAxis.options.left =
                                    navigator.left;
                            } else {
                                xAxis.options.top = yAxis.options.top =
                                    navigator.top;
                            }

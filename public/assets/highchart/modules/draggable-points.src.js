...
(function (factory) {
    ...
    _registerModule(
        _modules,
        "modules/draggable-points.src.js",
        ...
        */
            ...
            var columnDragDropProps = (seriesTypes.column.prototype.dragDropProps = {
                ...
                y: {
                    ...
                    beforeResize: function (guideBox, pointVals, point) {
                        ...
                        if (
                            pointVals.y >= point.series.options.threshold ||
                            0
                        ) {
                    ...
                    handlePositioner: function (point) {
                        ...
                        return {
                            x: bBox.x,
                            y:
                                point.y >= (point.series.options.threshold || 0)
                                    ? bBox.y
                                    : bBox.y + bBox.height,
                        };
                    },
            ...
            if (seriesTypes.columnrange) {
                seriesTypes.columnrange.prototype.dragDropProps = {
                    ...
                    low: {
                        ...
                        handlePositioner: function (point) {
                            var bBox =
                                point.shapeArgs || point.graphic.getBBox();
            ...
            if (seriesTypes.arearange) {
                ...
                seriesTypes.arearange.prototype.dragDropProps = {
                    ...
                    high: {
                        ...
                        handleFormatter: arearangeHandleFormatter,
                        propValidate:
                            columnrangeDragDropProps.high.propValidate,
                    },
                };
            }
            ...
            if (seriesTypes.xrange) {
                ...
                var xrangeHandlePositioner = function (point, xProp) {
                        ...
                        if (inverted) {
                            newX = xAxis.len - newX;
                            newY =
                                yAxis.len - newY - point.shapeArgs.height / 2;
                        } else {
             ...
             * default this is disabled, except for study axes, where the default is 1.
             *
             * @type      {number}
             * @default   0
             * @since     6.2.0
            ...
            function isPointMovable(point) {
                var series = point.series,
                    ...
                    pointDragDropOptions =
                        point.options && point.options.dragDrop,
                ...
                if (
                    !pick(
                        series.options.dragDrop &&
                            series.options.dragDrop.liveRedraw,
                        true
                    )
                ) {
                    chart.dragGuideBox = guideBox = series.getGuideBox(
                        groupedPoints
                    );
                    chart
                        .setGuideBoxState(
            ...
            H.Point.prototype.getDropValues = function (
                ...
                function limitToRange(val, direction) {
                    var defaultPrecision = series[
                            direction.toLowerCase() + "Axis"
                        ].categories
                            ? 1
                            : 0,
                        precision = pick(
                    ...
                    if (
                        ...
                        handleSide =
                            typeof val.resizeSide === "function"
                                ? val.resizeSide(point.options, point)
                                : val.resizeSide;
                        ...
                        if (!handle) {
                            handle = chart.dragHandles[
                                handleSide
                            ] = renderer.path().add(chart.dragHandles.group);
                        }
            ...
            function mouseMove(e, chart) {
                ...
                if (dragDropData && dragDropData.isDragging) {
                    ...
                    if (dragDropData.draggedPastSensitivity) {
                        ...
                        newPoint =
                            numNewPoints === 1 ? getFirstProp(newPoints) : null;
            ...
            H.Chart.prototype.zoomOrPanKeyPressed = function (e) {
                ...
                var chartOptions = this.userOptions.chart || {},
                    ...
                    zoomKey =
                        chartOptions.zoomKey && chartOptions.zoomKey + "Key";

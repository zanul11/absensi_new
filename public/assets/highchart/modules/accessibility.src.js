...
(function (factory) {
    ...
    _registerModule(
        _modules,
        "modules/accessibility/KeyboardNavigationHandler.js",
    ...
    _registerModule(
        ...
        function (Highcharts) {
            ...
            AccessibilityComponent.prototype = {
                 ...
                 */
                addEvent: function () {
                    var remover = Highcharts.addEvent.apply(
                        Highcharts,
                        arguments
                    );
                ...
                addProxyGroup: function (attrs) {
                    ...
                    if (
                        chart.container.nextSibling !== chart.a11yProxyContainer
                    ) {
    ...
    _registerModule(
        ...
        [
            _modules["parts/Globals.js"],
            _modules["modules/accessibility/KeyboardNavigationHandler.js"],
        ],
        function (H, KeyboardNavigationHandler) {
            /* *
             *
             *  (c) 2009-2019 Øystein Moseng
             *
            ...
            KeyboardNavigation.prototype = {
                ...
                init: function (chart, components) {
                    ...
                    this.unbindMouseUpHandler = addEvent(
                        doc,
                        "mouseup",
                        function () {
                ...
                update: function (order) {
                    var a11yOptions = this.chart.options.accessibility,
                        keyboardOptions =
                            a11yOptions && a11yOptions.keyboardNavigation,
                    ...
                    if (
                        ...
                        this.modules = order.reduce(
                            function (modules, componentName) {
                                var navModules = components[
                                    componentName
                ...
                addExitAnchor: function () {
                    var chart = this.chart,
                        exitAnchorWrapper = (this.exitAnchorWrapper = doc.createElement(
                            "div"
                        )),
                        exitAnchor = (this.exitAnchor = doc.createElement(
                            "h6"
                        )),
                        keyboardNavigation = this,
                        exitAnchorLabel = chart.langFormat(
                            "accessibility.svgContainerEnd",
                            { chart: chart }
                        );
                    ...
                    exitAnchorWrapper.setAttribute(
                        "class",
                        "highcharts-exit-anchor-wrapper"
                    );
                    ...
                    this.unbindExitAnchorUpdate = addEvent(
                        chart,
                        "render",
                        function () {
                ...
                destroy: function () {
                    ...
                    if (
                        ...
                        this.exitAnchorWrapper.parentNode.removeChild(
                            this.exitAnchorWrapper
                        );
    ...
    _registerModule(
        ...
        [
            _modules["parts/Globals.js"],
            _modules["modules/accessibility/AccessibilityComponent.js"],
            _modules["modules/accessibility/KeyboardNavigationHandler.js"],
        ],
        function (H, AccessibilityComponent, KeyboardNavigationHandler) {
            /* *
             *
             *  (c) 2009-2019 Øystein Moseng
             *
            ...
            H.Chart.prototype.highlightLegendItem = function (ix) {
                ...
                if (items[ix]) {
                    ...
                    if (
                        items[ix].pageIx !== undefined &&
                        items[ix].pageIx + 1 !== this.legend.currentPage
                    ) {
                        this.legend.scroll(
                            1 + items[ix].pageIx - this.legend.currentPage
                        );
                    }
                    // Focus
                                ...
                                [
                                    ...
                                    function (keyCode) {
                                        ...
                                        if (
                                            ...
                                            a11yOptions.keyboardNavigation
                                                .wrapAround
                                        ) {
    ...
    _registerModule(
        ...
        function (H, AccessibilityComponent, KeyboardNavigationHandler) {
            ...
            H.Chart.prototype.highlightExportItem = function (ix) {
                var listItem =
                        this.exportDivElements && this.exportDivElements[ix],
                    curHighlighted =
    ...
    _registerModule(
        _modules,
        "modules/accessibility/components/SeriesComponent.js",
        [
            _modules["parts/Globals.js"],
            _modules["modules/accessibility/AccessibilityComponent.js"],
            _modules["modules/accessibility/KeyboardNavigationHandler.js"],
        ...
        function (H, AccessibilityComponent, KeyboardNavigationHandler) {
            ...
            function isSkipSeries(series) {
                ...
                return (
                    (seriesKbdNavOptions &&
                        seriesKbdNavOptions.enabled === false) ||
            ...
            function isSkipPoint(point) {
                ...
                return (
                    (point.isNull &&
                        a11yOptions.keyboardNavigation.skipNullPoints) ||
                    point.visible === false ||
            ...
            function getClosestPoint(point, series, xWeight, yWeight) {
                ...
                while (i--) {
                    ...
                    if (
                        dPoint.plotX === undefined ||
                        dPoint.plotY === undefined
                    ) {
                        continue;
                    }
                    distance =
            ...
            H.Chart.prototype.highlightAdjacentPoint = function (next) {
                var chart = this,
                    ...
                    lastSeries =
                        chart.series && chart.series[chart.series.length - 1],
                    lastPoint =
                        lastSeries &&
                        lastSeries.points &&
            ...
            H.Chart.prototype.highlightAdjacentSeries = function (down) {
                ...
                newSeries =
                    chart.series[curPoint.series.index + (down ? -1 : 1)];
            ...
            H.Chart.prototype.highlightAdjacentPointVertical = function (down) {
                ...
                if (
                    curPoint.plotX === undefined ||
                    curPoint.plotY === undefined
                ) {
                    return false;
                }
                    ...
                    return chart.time.dateFormat(
                        (a11yOptions.pointDateFormatter &&
                            ...
                            H.Tooltip.prototype.getXDateFormat.call(
                                {
                                    getDateFormat:
                                        H.Tooltip.prototype.getDateFormat,
                                    chart: chart,
                                },
                                point,
                ...
                /** @lends Highcharts.SeriesComponent */ {
                        ...
                        chart.series.forEach(function (series) {
                            component[
                                (series.options.accessibility &&
                                    series.options.accessibility.enabled) !==
                                false
                                    ? "addSeriesDescription"
                                    : "hideSeriesFromScreenReader"
                            ](series);
                        });
                    },
                        ...
                        return new KeyboardNavigationHandler(chart, {
                            keyCodeMap: [
                                ...
                                [
                                    ...
                                    function () {
                                        if (chart.highlightedPoint) {
                                            chart.highlightedPoint.firePointEvent(
                                                "click"
                                            );
                                        }
                                    },
                    ...
                    isPointClickable: function (point) {
                        var seriesOpts = point.series.options || {},
                            seriesPointEvents =
                                seriesOpts.point && seriesOpts.point.events;
                        return (
                            point &&
                            point.graphic &&
                    ...
                    initAnnouncer: function () {
                        ...
                        this.announceRegion.setAttribute(
                            "aria-live",
                            a11yOptions.announceNewData.interruptUser
                                ? "assertive"
                                : "polite"
                        );
                        merge(
                            true,
                            this.announceRegion.style,
                            this.hiddenStyle
                        );
                        chart.renderTo.insertBefore(
                            this.announceRegion,
                            ...
                            function () {
                                ...
                                if (
                                    ...
                                    if (this.series && this.series.length) {
                                        var el = component.getSeriesElement(
                                            this.series[0]
                                        );
                                        if (
                                            el.focus &&
                        ...
                        this.addEvent(chart, "afterAddSeries", function (e) {
                            if (
                                ...
                                component.dirty.newSeries =
                                    component.dirty.newSeries === undefined
                                        ? series
                                        : null;
                            }
                        });
                        ...
                        this.addEvent(H.Series, "addPoint", function (e) {
                            if (
                                ...
                                component.dirty.newPoint =
                                    component.dirty.newPoint === undefined
                                        ? e.point
                                        : null;
                            }
                        });
                        ...
                        this.addEvent(chart, "redraw", function () {
                            if (
                                ...
                                if (newPoint) {
                                    newPoints = newPoint.series.data.filter(
                                        function (point) {
                                            return (
                                                point.x === newPoint.x &&
                                                point.y === newPoint.y
                                ...
                                component.announceNewData(
                                    Object.keys(component.dirty.allSeries).map(
                                        function (ix) {
                                            return component.dirty.allSeries[
                                                ix
                                            ];
                                        }
                                    ),
                    ...
                    announceNewData: function (
                        ...
                        if (annOptions.enabled) {
                            ...
                            if (this.queuedAnnouncement) {
                                ...
                                allSeries = Object.keys(uniqueSeries).map(
                                    function (ix) {
                            ...
                            if (message) {
                                ...
                                // Queue the announcement
                                component.queuedAnnouncementTimer = setTimeout(
                                    function () {
                                        if (
                                            component &&
                                            ...
                                            component.announceRegion.innerHTML =
                                                component.queuedAnnouncement.message;
                        ...
                        return chart.langFormat(
                            "accessibility.announceNewData." + langKey,
                            {
                                ...
                                seriesDesc: newSeries
                                    ? this.defaultSeriesDescriptionFormatter(
                                          newSeries
                                      )
                                    : null,
                                pointDesc: newPoint
                                    ? this.defaultPointDescriptionFormatter(
                                          newPoint
                                      )
                                    : null,
                                point: newPoint,
                    ...
                    getSeriesElement: function (series) {
                        var firstPointEl = this.getSeriesFirstPointElement(
                            series
                        );
                        return (
                    ...
                    addSeriesDescription: function (series) {
                        var component = this,
                            ...
                            seriesA11yOptions =
                                series.options.accessibility || {},
                            firstPointEl = component.getSeriesFirstPointElement(
                                series
                            ),
                        ...
                        if (seriesEl) {
                                        ...
                                        pointEl.setAttribute(
                                            ...
                                            component.stripTags(
                                                (seriesA11yOptions.pointDescriptionFormatter &&
                                                    ...
                                                    component.defaultPointDescriptionFormatter(
                                                        point
                                                    )
                                            )
                                        );
                            ...
                            if (
                                ...
                                a11yOptions.describeSingleSeries
                            ) {
                                ...
                                seriesEl.setAttribute(
                                    ...
                                    component.stripTags(
                                        (a11yOptions.seriesDescriptionFormatter &&
                                            ...
                                            component.defaultSeriesDescriptionFormatter(
                                                series
                                            )
                                    )
                                );
                    ...
                    defaultSeriesDescriptionFormatter: function (series) {
                        var chart = series.chart,
                            ...
                            summary =
                                ...
                                chart.langFormat(
                                    "accessibility.series.summary.default" +
                                        combination,
                                    summaryContext
                                );
                    ...
                    defaultPointDescriptionFormatter: function (point) {
                        var series = point.series,
                            ...
                            valuePrefix =
                                a11yOptions.pointValuePrefix ||
                                tooltipOptions.valuePrefix ||
                                "",
                            valueSuffix =
                                a11yOptions.pointValueSuffix ||
                            ...
                            keyCodeMap: [
                                ...
                                [
                                    ...
                                    function (keyCode, e) {
                                        ...
                                        // Select other button
                                        component.focusedMapNavButtonIx += e.shiftKey
                                            ? -1
                                            : 1;
                                        button =
                                            chart.mapNavButtons[
                        ...
                        return new KeyboardNavigationHandler(chart, {
                            keyCodeMap: [
                                ...
                                [
                                    ...
                                    function () {
                                        ...
                                        if (
                                            chart.oldRangeSelectorItemState !==
                                            3
                                        ) {
                                            component.fakeClickEvent(
                            ...
                            init: function (direction) {
                                chart.highlightRangeSelectorButton(
                                    direction > 0
                                        ? 0
                                        : chart.rangeSelector.buttons.length - 1
                                );
                            },
                        });
                    },
                        ...
                        return new KeyboardNavigationHandler(chart, {
                            ...
                            validate: function () {
                                var inputVisible =
                                    ...
                                    chart.rangeSelector.inputGroup.element.getAttribute(
                                        "visibility"
                                    ) !== "hidden";

                                return (
                                    inputVisible &&
                                    chart.options.rangeSelector.inputEnabled !==
                                        false &&
    ...
    _registerModule(
        _modules,
        "modules/accessibility/components/InfoRegionComponent.js",
        [
            _modules["parts/Globals.js"],
            _modules["modules/accessibility/AccessibilityComponent.js"],
        ],
        function (H, AccessibilityComponent) {
            /* *
             *
             *  (c) 2009-2019 Øystein Moseng
             *
            ...
            H.Chart.prototype.getTypeDescription = function (types) {
                var firstType = types[0],
                    ...
                    formatContext = {
                        ...
                        numPoints:
                            firstSeries.points && firstSeries.points.length,
                        chart: this,
                        mapTitle: mapTitle,
                    };
            ...
            H.extend(
                InfoRegionComponent.prototype,
                /** @lends Highcharts.InfoRegionComponent */ {
                    // eslint-disable-line
                    ...
                    init: function () {
                        ...
                        this.addEvent(chart, "afterGetTable", function (e) {
                            if (chart.options.accessibility.enabled) {
                                component.tableAnchor.setAttribute(
                                    "aria-expanded",
                                    true
                                );
                    ...
                    onChartUpdate: function () {
                        ...
                        var chart = this.chart,
                            a11yOptions = chart.options.accessibility,
                            hiddenSectionId =
                                "highcharts-information-region-" + chart.index,
                            hiddenSection = (this.screenReaderRegion =
                                this.screenReaderRegion ||
                        ...
                        if (
                            chart.getCSV &&
                            chart.options.accessibility.addTableShortcut
                        ) {
                            var tableId =
                                "highcharts-data-table-" + chart.index;
                            ...
                            tableShortcutAnchor.setAttribute(
                                "aria-expanded",
                                false
                            );
                            ...
                            desc.xAxis = chart.langFormat(
                                    ...
                                    (xAxes.length > 1 ? "Plural" : "Singular"),
                                {
                                    ...
                                    ranges: chart.xAxis.map(function (axis) {
                                        return component.getAxisRangeDescription(
                                            axis
                                        );
                                    }),
                    ...
                    getAxisRangeDescription: function (axis) {
                        ...
                        if (
                            ...
                            axisOptions.accessibility.rangeDescription !==
                                undefined
                        ) {
                        ...
                        if (
                            ...
                            ["Minutes", "Hours", "Days"].forEach(function (
                                unit
                            ) {
                                if (range[unit] > 2) {
                                    rangeUnit = unit;
                            ...
                            "accessibility.axis.rangeFromTo",
                            {
                                ...
                                rangeFrom: axis.isDatetimeAxis
                                    ? chart.time.dateFormat(
                                          a11yOptions.axisRangeDateFormat,
                                          axis.min
                                      )
                                    : axis.min,
                ...
                /** @lends Highcharts.ContainerComponent */ {
                    ...
                    onChartUpdate: function () {
                        var chart = this.chart,
                            ...
                            svgContainerTitle = this.stripTags(
                                chart.langFormat(
                            ...
                            svgContainerLabel = this.stripTags(
                                chart.langFormat(
                        ...
                        if (chart.renderer.box && svgContainerLabel.length) {
                            chart.renderer.box.setAttribute(
                                "aria-label",
                                svgContainerLabel
                            );
                        }
    ...
    _registerModule(
        _modules,
        "modules/accessibility/options.js",
        [],
        function () {
            /* *
             *
    ...
    _registerModule(
        _modules,
        "modules/accessibility/a11y-i18n.js",
        [_modules["parts/Globals.js"]],
        function (H) {
            /* *
            ...
            function formatExtendedStatement(statement, ctx) {
                ...
                if (pluralStart > -1) {
                    var pluralEnd =
                            statement.slice(pluralStart).indexOf(")") +
                            pluralStart,
                ...
                if (indexStart > -1) {
                    var arrayName = statement.substring(0, indexStart),
                        ix = Number(
                            statement.substring(indexStart + 1, indexEnd)
                        ),
                        val;
            ...
            H.i18nFormat = function (formatString, context, time) {
                ...
                tokens.forEach(function (token) {
                    if (token.type === "statement") {
                        token.value = formatExtendedStatement(
                            token.value,
                            context
                        );
                    }
                ...
                // statements.
                return H.format(
                    tokens.reduce(function (acc, cur) {
                ...
                lang: {
                    ...
                    accessibility: {
                        ...
                        axis: {
                            ...
                            rangeCategories:
                                "Range: {numCategories} categories.",
                        } /* eslint-enable max-len */,
    ...
    _registerModule(
        ...
        [
            ...
            _modules["modules/accessibility/KeyboardNavigationHandler.js"],
            _modules["modules/accessibility/AccessibilityComponent.js"],
            _modules["modules/accessibility/KeyboardNavigation.js"],
            _modules["modules/accessibility/components/LegendComponent.js"],
            _modules["modules/accessibility/components/MenuComponent.js"],
            _modules["modules/accessibility/components/SeriesComponent.js"],
            _modules["modules/accessibility/components/ZoomComponent.js"],
            _modules[
                "modules/accessibility/components/RangeSelectorComponent.js"
            ],
            _modules["modules/accessibility/components/InfoRegionComponent.js"],
            _modules["modules/accessibility/components/ContainerComponent.js"],
            _modules["modules/accessibility/options.js"],
        ],
        function (
            H,
            ...
            H.Axis.prototype.getDescription = function () {
                return (
                    (this.userOptions &&
                        this.userOptions.accessibility &&
                ...
                copyDeprecatedOptions: function () {
                    ...
                    chart.axes.forEach(function (axis) {
                        ...
                        if (opts && opts.description) {
                            ...
                            warn(
                                "axis.description",
                                "axis.accessibility.description"
                            );
                        }
                    });

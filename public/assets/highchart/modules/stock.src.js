...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/stock", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
        ...
        function (H) {
                ...
                /** @lends Axis.prototype */ {
                    ...
                    val2lin: function (val, toIndex) {
                        ...
                        if (!ordinalPositions) {
                            ...
                            ret = toIndex
                                ? ordinalIndex
                                : axis.ordinalSlope * (ordinalIndex || 0) +
                                  axis.ordinalOffset;
                        }
                        return ret;
                    },
                ...
                if (xAxis.options.ordinal && xAxis.series.length) {
                    ...
                    if (!extendedAxis.ordinalPositions) {
                        ...
                        if (movedUnits < 0) {
                            ...
                            searchAxisRight = xAxis.ordinalPositions
                                ? xAxis
                                : extendedAxis;
                        } else {
                            searchAxisLeft = xAxis.ordinalPositions
                                ? xAxis
                                : extendedAxis;
                        ...
                        if (
                            trimmedRange.min >=
                                Math.min(extremes.dataMin, min) &&
                            trimmedRange.max <=
                                Math.max(dataMax, max) + overscroll
                        ) {
                            xAxis.setExtremes(
                                trimmedRange.min,
                                trimmedRange.max,
            ...
            addEvent(Axis, "foundExtremes", function () {
                ...
                if (
                    ...
                    (!axis.eventArgs ||
                        (axis.eventArgs &&
                            axis.eventArgs.trigger !== "navigator"))
                ) {
        ...
        function (H) {
            ...
            var groupData = function (
                ...
                var series = this,
                    ...
                    extendedPointArrayMap = ["x"].concat(
                        pointArrayMap || ["y"]
                    ),
                    pos = 0,
                    start = 0,
            ...
            seriesProto.getDGApproximation = function () {
                ...
                if (
                    ...
                    this instanceof H.seriesTypes.column
                ) {
                    return "sum";
                }
                return "average";
                    ...
                    if (groupPixelWidth) {
                        ...
                        for (i = 1; i < groupPositions.length; i++) {
                            ...
                            if (
                                ...
                                groupPositions.info.segmentStarts.indexOf(i) ===
                                    -1
                            ) {
                                gapSize = Math.max(
                        ...
                        series.closestPointRange =
                            groupPositions.info.totalRange;
            ...
            Axis.prototype.getGroupPixelWidth = function () {
                ...
                while (i--) {
                    ...
                    if (dgOptions && series[i].hasProcessed) {
                        ...
                        dataLength = (
                            series[i].processedXData || series[i].data
                        ).length;
        ...
        function (H) {
            ...
            seriesType(
                 ...
                 */
                {
                     ...
                     */
                    init: function () {
                        seriesTypes.column.prototype.init.apply(
                            this,
                            arguments
                        );
                        ...
                        series.points.forEach(function (point) {
                            [
                                ...
                                if (value !== null) {
                                    ...
                                    point[translated[i]] = yAxis.toPixels(
                                        value,
                                        true
                                    );
                                }
                    ...
                    drawPoints: function () {
                        ...
                        points.forEach(function (point) {
                            ...
                            if (point.plotY !== undefined) {
                                ...
                                if (point.open !== null) {
                                    plotOpen =
                                        Math.round(point.plotOpen) + crispCorr;
                                    path.push(
                                        "M",
                                        crispX,
                                        plotOpen,
                                ...
                                if (point.close !== null) {
                                    plotClose =
                                        Math.round(point.plotClose) + crispCorr;
                                    path.push(
                                        "M",
                                        crispX,
                                        plotClose,
                 ...
                 */
                {
                    ...
                    pointAttribs: function (point, state) {
                        ...
                        if (state) {
                            ...
                            attribs.stroke =
                                stateOptions.lineColor || attribs.stroke;
                            attribs["stroke-width"] =
                                stateOptions.lineWidth ||
                                attribs["stroke-width"];
                        }
            ...
            var onSeriesMixin = {
                ...
                translate: function () {
                    ...
                    var series = this,
                        ...
                        onSeries =
                            optionsOnSeries && chart.get(optionsOnSeries),
                    ...
                    if (onSeries && onSeries.visible && i) {
                        xOffset =
                            (onSeries.pointXOffset || 0) +
                            (onSeries.barW || 0) / 2;
                        currentDataGrouping = onSeries.currentDataGrouping;
                        lastX =
                            onData[i - 1].x +
                            (currentDataGrouping
                                ? currentDataGrouping.totalRange
                                : 0); // #2374
                        ...
                        onKey =
                            "plot" + onKey[0].toUpperCase() + onKey.substr(1);
                            ...
                            if (point.plotX >= 0 && point.plotX <= xAxis.len) {
                                ...
                                if (inverted) {
                                    ...
                                    point.plotY =
                                        (xAxis.opposite
                                            ? 0
                                            : series.yAxis.len) + xAxis.offset; // For the windbarb demo
                                }
                            } else {
                                point.shapeArgs = {}; // 847
                            }
    ...
    _registerModule(
        ...
        [_modules["parts/Globals.js"], _modules["mixins/on-series.js"]],
                 ...
                 */
                {
                    ...
                    pointAttribs: function (point, state) {
                        var options = this.options,
                            ...
                            fill =
                                (point && point.fillColor) || options.fillColor;
                    ...
                    drawPoints: function () {
                        ...
                        if (!options.allowOverlapX) {
                            ...
                            points.forEach(function (point) {
                                var box =
                                    point.graphic && boxesMap[point.plotX];
        ...
        function (H) {
                    ...
                    return merge(
                        {
                             ...
                             */
                            showLastLabel: !!(
                                // #6104, show last label by default for study axes
                                (
                ...
                options = merge(
                    {
                        ...
                        rangeSelector: {
                            // #4988 - check if setOptions was called
                            enabled: pick(
                                defaultOptions.rangeSelector.enabled,
                                true
                            ),
                        },
                        title: {
            ...
            addEvent(Series, "setOptions", function (e) {
                ...
                function is(type) {
                    return (
                        H.seriesTypes[type] &&
                        series instanceof H.seriesTypes[type]
                    );
                }
            ...
            addEvent(Axis, "afterDrawCrosshair", function (event) {
                ...
                crossLabel.attr({
                    ...
                    visibility:
                        value < min || value > max ? "hidden" : "visible",
                });
            ...
            addEvent(Series, "render", function () {
                ...
                if (
                    ...
                    if (!this.clipBox && this.animate) {
                        ...
                        if (this.chart[this.sharedClipKey + "m"]) {

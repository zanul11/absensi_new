...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/modules/heatmap", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
    ...
    _registerModule(
        ...
        function (H) {
            ...
            extend(ColorAxis.prototype, {
                 ...
                 * a true study. However, when your data is categorized, it may be as
                 * convenient to add each study to a separate series.
                 *
                ...
                defaultColorAxisOptions: {
                     ...
                     * value, `study`, pulls colors from the global or chart specific
                     * [colors](#colors) array.
                     *
                ...
                update: function (newOptions, redraw) {
                    var chart = this.chart,
                        legend = chart.legend,
                        updatedOptions = this.buildOptions.call(
                            chart,
                            {},
                            newOptions
                        );
                ...
                getDataClassLegendSymbols: function () {
                    ...
                    if (!legendItems.length) {
                        this.dataClasses.forEach(function (dataClass, i) {
                            ...
                            if (from !== undefined) {
                                name +=
                                    H.numberFormat(from, valueDecimals) +
                                    valueSuffix;
                            }
                            ...
                            if (to !== undefined) {
                                name +=
                                    H.numberFormat(to, valueDecimals) +
                                    valueSuffix;
                            }
            ...
            seriesType(
                ...
                merge(colorSeriesMixin, {
                    ...
                    init: function () {
                        ...
                        seriesTypes.scatter.prototype.init.apply(
                            this,
                            arguments
                        );
    ...
    _registerModule(
        _modules,
        "masters/modules/heatmap.src.js",
        [],
        function () {}
    );
});

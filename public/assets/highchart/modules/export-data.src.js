    ...
    _registerModule(
        ...
        function (Highcharts) {
                ...
                var time = this.time,
                    ...
                    columnHeaderFormatter = function (item, key, keyLength) {
                        if (csvOptions.columnHeaderFormatter) {
                            var s = csvOptions.columnHeaderFormatter(
                                item,
                                key,
                                keyLength
                            );
                    ...
                    if (
                        ...
                        while (j < valueCount) {
                            ...
                            if (multiLevelHeaders) {
                                topLevelColumnTitles.push(
                                    columnTitleObj.topLevelColumnTitle ||
                                        columnTitleObj
                                );
                            }
                            j++;
                        ...
                        series.options.data.forEach(function eachData(
                            ...
                            while (j < valueCount) {
                                ...
                                val = point[prop];
                                rows[key][i + j] = pick(
                                    categoryMap[prop][val], // Y axis study if present
                                    datetimeValueAxisMap[prop]
                                        ? time.dateFormat(
            ...
            Highcharts.Chart.prototype.getTable = function (
                ...
                var html =
                        '<table id="highcharts-data-table-' + this.index + '">',
                    options = this.options,
                    decimalPoint = useLocalDecimalPoint
                        ? (1.1).toLocaleString()[1]
                        : ".",
                    ...
                    getTableHeaderHTML = function (
                        ...
                        var html = "<thead>",
                            i = 0,
                            len =
                                rowLength || (subheaders && subheaders.length),
                            next,
                            cur,
                            curColspan = 0,
                            rowspan;
                        ...
                        if (
                            ...
                            for (; i < len; ++i) {
                                ...
                                if (cur === next) {
                                    ...
                                    if (cur === subheaders[i]) {
                                        if (
                                            options.exporting.useRowspanHeaders
                                        ) {
                                            rowspan = 2;
                                            delete subheaders[i];
                                        } else {
                ...
                rows.forEach(function (row) {
                    ...
                    for (var j = 0; j < rowLength; j++) {
                        ...
                        // study axes, but also might make sense for datetime? Should
            ...
            Highcharts.Chart.prototype.openInCloud = function () {
                ...
                function openInCloud() {
                    ...
                    form.method = "post";
                    form.action =
                        "https://cloud-api.highcharts.com/openincloud";
                    form.target = "_blank";
                ...
                paramObj = {
                    name:
                        (options.title && options.title.text) || "Chart title",
                    options: options,
                    settings: {
                        constructor: "Chart",
                        dataProvider: {

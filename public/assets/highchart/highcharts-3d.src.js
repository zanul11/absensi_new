...
(function (factory) {
    if (typeof module === "object" && module.exports) {
        ...
        define("highcharts/highcharts-3d", ["highcharts"], function (
            Highcharts
        ) {
            factory(Highcharts);
    ...
    _registerModule(
        ...
        function (H) {
            ...
            H.shapeArea3d = function (vertexes, chart, insidePlotArea) {
                return H.shapeArea(
                    H.perspective(vertexes, chart, insidePlotArea)
                );
            };
        }
    );
    _registerModule(
        ...
        */
            ...
            // Base, abstract prototype student for 3D elements
            element3dMethods = {
            ...
            cuboidMethods = H.merge(element3dMethods, {
                ...
                animate: function (args, duration, complete) {
                    if (defined(args.x) && defined(args.y)) {
                        ...
                        SVGElement.prototype.animate.call(
                            this,
                            args,
                            duration,
                            complete
            ...
            function getScale(chart, depth) {
                ...
                if (plotBottom < bbox3d.maxY) {
                    scale = Math.min(
                        scale,
                        Math.abs(
                            (plotBottom - originY) / (bbox3d.maxY - originY)
                        )
                    );
                }
            ...
            addEvent(Chart, "afterDrawChartBox", function () {
                if (this.is3d()) {
                    var chart = this,
                        ...
                        ypp =
                            yp + (frame.bottom.visible ? frame.bottom.size : 0),
                    ...
                    this.frameShapes.bottom[verb]({
                        ...
                        faces: [
                            {
                                // bottom
                                fill: H.color(frame.bottom.color)
                                    .brighten(0.1)
                                    .get(),
                                vertexes: [
                                    {
                            ...
                            },
                            {
                                ...
                                enabled:
                                    frame.bottom.visible && !frame.left.visible,
                            },
                            {
                                // right
                                fill: H.color(frame.bottom.color)
                            ...
                            },
                            {
                                ...
                                enabled:
                                    frame.bottom.visible && !frame.back.visible,
                            },
                        ],
                    });
                    this.frameShapes.top[verb]({
                        ...
                        faces: [
                            ...
                            },
                            {
                                ...
                                enabled:
                                    frame.top.visible && !frame.left.visible,
                            },
                            {
                                // right
                                fill: H.color(frame.top.color)
                                ...
                                enabled:
                                    frame.top.visible && !frame.right.visible,
                            },
                            {
                                // front
                                ...
                                enabled:
                                    frame.top.visible && !frame.front.visible,
                            },
                            {
                                // back
                                fill: H.color(frame.top.color).get(),
                                ...
                                enabled:
                                    frame.top.visible && !frame.back.visible,
                            },
                        ],
                    });
                        ...
                        faces: [
                            {
                                ...
                                enabled:
                                    frame.left.visible && !frame.bottom.visible,
                            },
                            {
                                // top
                                fill: H.color(frame.left.color)
                                ...
                                enabled:
                                    frame.left.visible && !frame.top.visible,
                            },
                            {
                                // left
                                fill: H.color(frame.left.color)
                            ...
                            },
                            {
                                ...
                                enabled:
                                    frame.left.visible && !frame.front.visible,
                            },
                            {
                                // back
                                fill: H.color(frame.left.color).get(),
                                ...
                                enabled:
                                    frame.left.visible && !frame.back.visible,
                            },
                        ],
                    });
                    this.frameShapes.right[verb]({
                        ...
                        faces: [
                            {
                                // bottom
                                fill: H.color(frame.right.color)
                                    .brighten(0.1)
                                    .get(),
                                vertexes: [
                                    {
                            ...
                            },
                            {
                                ...
                                enabled:
                                    frame.right.visible && !frame.top.visible,
                            },
                            {
                                // left
                                fill: H.color(frame.right.color)
                            ...
                            },
                            {
                                ...
                                enabled:
                                    frame.right.visible && !frame.front.visible,
                            },
                            {
                                // back
                                fill: H.color(frame.right.color).get(),
                                ...
                                enabled:
                                    frame.right.visible && !frame.back.visible,
                            },
                        ],
                    });
                        ...
                        faces: [
                            {
                                ...
                                enabled:
                                    frame.back.visible && !frame.bottom.visible,
                            },
                            {
                                // top
                                fill: H.color(frame.back.color)
                                ...
                                enabled:
                                    frame.back.visible && !frame.top.visible,
                            },
                            {
                                // left
                                fill: H.color(frame.back.color)
                                ...
                                enabled:
                                    frame.back.visible && !frame.left.visible,
                            },
                            {
                                // right
                                fill: H.color(frame.back.color)
                                ...
                                enabled:
                                    frame.back.visible && !frame.right.visible,
                            },
                            {
                                // front
                    ...
                    this.frameShapes.front[verb]({
                        ...
                        faces: [
                            {
                                // bottom
                                fill: H.color(frame.front.color)
                                    .brighten(0.1)
                                    .get(),
                                vertexes: [
                                    {
                            ...
                            },
                            {
                                ...
                                enabled:
                                    frame.front.visible && !frame.top.visible,
                            },
                            {
                                // left
                                fill: H.color(frame.front.color)
                                ...
                                enabled:
                                    frame.front.visible && !frame.left.visible,
                            },
                            {
                                // right
                                fill: H.color(frame.front.color)
                                ...
                                enabled:
                                    frame.front.visible && !frame.right.visible,
                            },
                            {
                                // front
    ...
    _registerModule(
        ...
        function (H) {
            ...
            addEvent(Series, "afterInit", function () {
                if (this.chart.is3d() && this.handle3dGrouping) {
                    var seriesOptions = this.options,
                        ...
                        reversedStacks = pick(
                            this.yAxis.options.reversedStacks,
                            true
                        ),
                        z = 0;
            ...
            if (seriesTypes.columnrange) {
                wrap(
                    seriesTypes.columnrange.prototype,
                    "pointAttribs",
                    pointAttribs
                );
            ...
            wrap(
                ...
                "getStackBox",
                function (proceed, chart) {
                    // #3946
                    var stackBox = proceed.apply(
                        this,
            ...
            wrap(
                ...
                function (proceed, point, state) {
                    ...
                    if (this.chart.is3d() && !this.chart.styledMode) {
                        attr.stroke =
                            options.edgeColor || point.color || this.color;
                    ...
                    if (this.chart.is3d()) {
                        ...
                        series.data.forEach(function (point) {
                            var shapeArgs = point.shapeArgs,
                                ...
                                a1 =
                                    (shapeArgs.alpha || options3d.alpha) *
                                    deg2rad,
                                b1 =
                                    (shapeArgs.beta || options3d.beta) *
                                    deg2rad,
                ...
                },
                {
                    pointAttribs: function (point) {
                        ...
                        if (this.chart.is3d() && point) {
                            attribs.zIndex = H.pointCameraDistance(
                                point,
                                this.chart
                            );
                        }
    ...
    _registerModule(
        ...
        function (H) {
            ...
            if (VMLRenderer) {
                ...
                VMLRenderer.prototype.polyhedron =
                    SVGRenderer.prototype.polyhedron;

                VMLRenderer.prototype.elements3d =
                    SVGRenderer.prototype.elements3d;
                VMLRenderer.prototype.element3d =
                    SVGRenderer.prototype.element3d;
                VMLRenderer.prototype.cuboid = SVGRenderer.prototype.cuboid;
                VMLRenderer.prototype.cuboidPath =
                    SVGRenderer.prototype.cuboidPath;

                VMLRenderer.prototype.toLinePath =
                ...
                VMLRenderer.prototype.arc3d = function (shapeArgs) {
                    var result = SVGRenderer.prototype.arc3d.call(
                        this,
                        shapeArgs
                    );
                ...
                H.VMLRenderer.prototype.arc3dPath =
                    H.SVGRenderer.prototype.arc3dPath;

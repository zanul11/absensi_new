        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 user-profile layout-spacing">
            <div class="widget-content widget-content-area">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{route('jadwal_shift.index')}}" class="mt-2 edit-profile">
                ...
                <div class="row">
                    <div class="col-lg-12 col-12 ">
                        ...
                        <form action="{{ request()->routeIs('jadwal_shift.create')?route('jadwal_shift.store') : route('jadwal_shift.update',$jadwalShift) }}" method="post" data-parsley-validate="true">
                            @csrf
                            @if (request()->routeIs('jadwal_shift.create'))
                            @method('post')
                            @else
                            @method('put')
                            @endif
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <p>Jam Pulang</p>
                                    <input class="form-control flatpickr flatpickr-input basicFlatpickr" type="text" value="{{(isset($jadwalShift))?date('H:i', strtotime($jadwalShift->jam_pulang)):''}}" name="jam_pulang" required>
                                </div>
                                <div class="form-group col-lg-6">
                                    <p>Jam Keluar Istirahat</p>
                                    <input class="form-control flatpickr flatpickr-input basicFlatpickr" value="{{(isset($jadwalShift))?date('H:i', strtotime($jadwalShift->jam_keluar_istirahat)):''}}" type="text" name="jam_keluar_istirahat" required>
                                </div>
                                <div class="form-group col-lg-6">
                                    <p>Jam Kembali Istirahat</p>
                                    <input class="form-control flatpickr flatpickr-input basicFlatpickr" type="text" value="{{(isset($jadwalShift))?date('H:i', strtotime($jadwalShift->jam_masuk_istirahat)):''}}" name="jam_masuk_istirahat" required>
                                </div>
                            </div>
...
<script>
    let firstZoom = 9;
    let map;
    let markerHandle = "{!! old('longlat',$jadwalShift->longlat??'') !!}";
    if (!'{{request()->routeIs("jadwal_shift.create")}}')
        firstZoom = 18
    ...
    function initMap() {
        ...
        }).setView(JSON.parse("{!! old('longlat',$jadwalShift->longlat??'[-8.711051242084778, 116.85531381363474]') !!}"), firstZoom);

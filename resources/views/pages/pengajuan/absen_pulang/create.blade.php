            ...
            <div class="widget-content widget-content-area">
                ...
                <div class="row">
                    <div class="col-lg-12 col-12 ">
                        ...
                        <form action="{{ request()->routeIs('request_absen_pulang.create')?route('request_absen_pulang.store') : route('request_absen_pulang.update',$kehadiran) }}" method="post" data-parsley-validate="true" enctype="multipart/form-data">
                            @csrf

        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 user-profile layout-spacing">
            <div class="widget-content widget-content-area">
                <div class="d-flex justify-content-between">
                    ...
                    <h3 class="">Form Request Tidak Masuk</h3>
                ...
                <div class="row">
                    <div class="col-lg-12 col-12 ">
                        ...
                        <form action="{{ request()->routeIs('tidak_masuk.create')?route('tidak_masuk.store') : route('tidak_masuk.update',$tidakMasuk) }}" method="post" data-parsley-validate="true" enctype="multipart/form-data">
                            @csrf
                            @if (request()->routeIs('tidak_masuk.create'))
                            @method('post')
                            @else
                            @method('put')
                            @endif
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-12 col-xs-12">
                                    <p>Jenis Izin</p>
                                    <select class="form-control " data-live-search="true" name="jenis_izin_id" required>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                                    <p>Keterangan</p>
                                    <textarea id="keterangan" name="keterangan" class="form-control" required>{{ old('keterangan',$tidakMasuk->keterangan??'') }}</textarea>
                                </div>
                                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                                    <p>Foto</p>
